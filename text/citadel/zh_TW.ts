...
'<25>{#f/6}* ...',
            ...
            respawn7: () =>
                [
                    ...
                    [
                        '<25>{#p/asriel2}{#f/15}* ...',
                        '<25>{#p/asriel2}{#f/15}* $(name)？',
                        '<32>{#p/human}* （看起來Asriel陷入了沉思。）'
                    ],
                    ['<25>{#p/asriel2}{#f/15}* ...', '<32>{#p/human}* （看起來Asriel陷入了沉思。）']
        ...
        npc: {
            ...
            picnic_papyrus: pager.create(
                0,
                [
                    '<18>{#p/papyrus}{#f/0}{#npc/a}你好啊，FRISK！',
                    "<18>{#f/9}我正做菜呢，做的還是\n我最拿手的好菜！",
                    "<18>{#f/5}只是火候不行，\n得花好長時間...",
                    "<18>{#f/7}照這樣下去，等我做好了，\n大夥都坐飛船出發了！",
            ...
            postnoot0: () =>
                world.trueKills === 0 && SAVE.data.n.state_foundry_undyne !== 1 && SAVE.flag.n.neutral_twinkly_choice === 0
                    ? [
                        ...
                        ...(SAVE.data.n.plot_date === 2.1
                            ? [
                                "<25>{*}{#e/twinkly/15}再去見見Asgore怎麼樣？",
                                "<25>{*}{#e/twinkly/17}你只要這麼做了，\n我保證不會再殺他。"
                            ]
                            : 1.1 <= SAVE.data.n.plot_date
                                ? [
                                    "<25>{*}{#e/twinkly/15}去會會Undyne怎麼樣？",
...
'<25>{#f/0}* 重要的是...',
            ...
            jspeech5b5a: ["<25>{#p/sans}{#f/3}* ...看來toriel入不了你的眼，\n  不值得施捨善心。\n  是不是啊？"],
            jspeech5b5b: ['<25>{#p/sans}{#f/3}* ...你都對toriel動了手，\n  我評判你兩句\n  其實也無可厚非。'],
            jspeech5b6a: ["<25>{*}{#p/darksans}{#f/1}{#i/5}* ...那你為什麼要\n  濫殺無辜？"],
            jspeech5b6b: ['<25>{*}{#p/darksans}{#f/1}{#i/5}* ...好個骯髒的連環殺手。'],
            jspeech5b7a: ["<25>{#p/sans}{#f/3}* ...看來undyne入不了你的眼，\n  不值得施捨善心。\n  是不是啊？"],
            jspeech5b7b: ['<25>{#p/sans}{#f/3}* ...你都對undyne動了手，\n  我評判你兩句\n  其實也無可厚非。'],
            jspeech5b8a: ["<25>{#p/sans}{#f/3}* ...看來mettaton入不了你的眼，\n  不值得施捨善心。\n  是不是啊？"],
            jspeech5b8b: ['<25>{#p/sans}{#f/3}* ...你都對mettaton動了手，\n  我評判你兩句\n  其實也無可厚非。'],
                    ...
                    SAVE.data.b.svr
                        ...
                        : [
                            ...(SAVE.data.b.oops
                                ...
                                : ['<32>{#p/basic}* Frisk...', "<32>* 我們還有事沒做呢，\n  你忘了嗎？"]),
                            choicer.create('* （離開這裡嗎？）', "我想\n再等等", "\n現在離開")
                        ],
                [choicer.create('* （離開這裡嗎？）', "我想\n再等等", "\n現在離開")]
            ),
            finaltext2: ['<32>{#p/basic}* Frisk？', choicer.create('* （離開這裡嗎？）', "我想\n再等等", "\n現在離開")],
                ...
                SAVE.data.b.c_state_secret5_used
                    ? SAVE.data.b.c_state_secret1_used
                        ? [
                            ...
                            '<32>{#p/human}* （你微笑著點了點頭。）',
                            '<25>{#p/asgore}{#f/21}* 你看，Frisk也想留住你呢。',
                            '<25>{#p/toriel}{#f/23}* ...',
...
'',
            ...
            returnofchara1: ['<32>{#p/basic}* Frisk...', '<32>* ...還在嗎？'],
            returnofchara2: [
            ...
            garden: () =>
                SAVE.data.b.svr
                    ...
                    : world.darker
                        ...
                        : [
                            '<32>{#p/basic}* 滿園星花，\n  最適合種在大窗戶旁邊了。',
                            ...(SAVE.data.b.oops ? [] : ['<32>{#p/basic}* 在這方面，Asgore絕對是行家！'])
                        ],
                    ...
                    SAVE.data.n.bully < 15 &&
                        ...
                        ? [
                            [
                                ...
                                "<32>{#p/human}* （你跟Alphys說了點悄悄話。）",
                                '<25>{#p/alphys}{#f/2}* ...',
                                "<25>{#p/alphys}{#g/alphysNervousLaugh}* 呃... 你-你...\n  真那樣做了？？",
                                "<32>{#p/human}* （你又跟Alphys說了點悄悄話。）",
            ...
            c_aa_deathbed: () =>
                SAVE.data.b.svr
                    ? [
                        ['<25>{#p/asriel1}{#f/13}* ...'],
                        [
                            "<25>{#p/asriel1}{#f/23}* ...沒事的，Frisk。",
                            "<25>{#f/13}* 即使那傢伙不會回來...",
                            "<25>{#f/17}* 我們也將永遠銘記\n  我們共同的朋友\n  為我們所做的一切。"
                        ],
                        ['<25>{#p/asriel1}{#f/13}* Frisk...', '<25>{#f/17}* 時候不早了，\n  我們也該去做\n  更有意義的事了。']
