...
export default {
    a_citadel: {
        ...
        hypertext: {
            ...
            cyan1: [
                ...
                '<99>{*}{#p/human}{#v/1}{@fill=#42fcff}Deberás conseguir mi Cucharón Pequeño...',
        ...
        story: {
            ...
            postnoot0: () =>
                world.trueKills === 0 && SAVE.data.n.state_foundry_undyne !== 1 && SAVE.flag.n.neutral_twinkly_choice === 0
                    ? [
                        '<25>{*}{#p/twinkly}{#f/19}{#e/twinkly/1}¿Por qué...?',
    ...
    b_opponent_alphys: {
        ...
        turnTalk20: ['<20>{#p/alphys}{#e/alphys/24}Jajaja...'],
    ...
    b_opponent_asriel: {
        ...
        endTalk5: ['<20>{*}{#p/asriel3}{#e/asriel/11}{#i/4}Yo...']
    },
    b_opponent_lostsoul: {
        name: '* Lost Soul',
        act_check_alphys: () => [
    ...
    b_opponent_finalasgore: {
        ...
        death1: [
            ...
            '<11>{*}{#e/asgore/2}{#v/3}{#i/7}{@random=1.1/1.1}Adiós...'
        ]
    },
