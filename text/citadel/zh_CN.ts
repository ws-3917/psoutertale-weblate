            ...
            respawn7: () =>
                [
                    ...
                    [
                        '<25>{#p/asriel2}{#f/15}* ...',
                        '<25>{#p/asriel2}{#f/15}* $(name)？',
                        '<32>{#p/human}* （看起来Asriel陷入了沉思。）'
                    ],
                    ['<25>{#p/asriel2}{#f/15}* ...', '<32>{#p/human}* （看起来Asriel陷入了沉思。）']
            ...
            postnoot0: () =>
                world.trueKills === 0 && SAVE.data.n.state_foundry_undyne !== 1 && SAVE.flag.n.neutral_twinkly_choice === 0
                    ? [
                        ...
                        ...(SAVE.data.n.plot_date === 2.1
                            ? [
                                "<25>{*}{#e/twinkly/15}再去见见Asgore怎么样？",
                                "<25>{*}{#e/twinkly/17}你只要这么做了，\n我保证不会再杀他。"
                            ]
                            : 1.1 <= SAVE.data.n.plot_date
                                ? [
                                    "<25>{*}{#e/twinkly/15}去会会Undyne怎么样？",
...
'<25>{#f/0}* 重要的是...',
            ...
            jspeech5b5a: ["<25>{#p/sans}{#f/3}* ...看来toriel入不了你的眼，\n  不值得施舍善心。\n  是不是啊？"],
            jspeech5b5b: ['<25>{#p/sans}{#f/3}* ...你都对toriel动了手，\n  我评判你两句\n  其实也无可厚非。'],
            jspeech5b6a: ["<25>{*}{#p/darksans}{#f/1}{#i/5}* ...那你为什么要\n  滥杀无辜？"],
            jspeech5b6b: ['<25>{*}{#p/darksans}{#f/1}{#i/5}* ...好个肮脏的连环杀手。'],
            jspeech5b7a: ["<25>{#p/sans}{#f/3}* ...看来undyne入不了你的眼，\n  不值得施舍善心。\n  是不是啊？"],
            jspeech5b7b: ['<25>{#p/sans}{#f/3}* ...你都对undyne动了手，\n  我评判你两句\n  其实也无可厚非。'],
            jspeech5b8a: ["<25>{#p/sans}{#f/3}* ...看来mettaton入不了你的眼，\n  不值得施舍善心。\n  是不是啊？"],
            jspeech5b8b: ['<25>{#p/sans}{#f/3}* ...你都对mettaton动了手，\n  我评判你两句\n  其实也无可厚非。'],
                    ...
                    SAVE.data.b.svr
                        ...
                        : [
                            ...(SAVE.data.b.oops
                                ...
                                : ['<32>{#p/basic}* Frisk...', "<32>* 我们还有事没做呢，\n  你忘了吗？"]),
                            choicer.create('* （离开这里吗？）', "我想\n再等等", "\n现在离开")
                        ],
                [choicer.create('* （离开这里吗？）', "我想\n再等等", "\n现在离开")]
            ),
            finaltext2: ['<32>{#p/basic}* Frisk？', choicer.create('* （离开这里吗？）', "我想\n再等等", "\n现在离开")],
...
'',
            ...
            returnofchara1: ['<32>{#p/basic}* Frisk...', '<32>* ...还在吗？'],
            returnofchara2: [
            ...
            garden: () =>
                SAVE.data.b.svr
                    ...
                    : world.darker
                        ...
                        : [
                            '<32>{#p/basic}* 满园星花，\n  最适合种在大窗户旁边了。',
                            ...(SAVE.data.b.oops ? [] : ['<32>{#p/basic}* 在这方面，Asgore绝对是行家！'])
                        ],
                    ...
                    SAVE.data.n.bully < 15 &&
                        ...
                        ? [
                            [
                                ...
                                "<32>{#p/human}* （你跟Alphys说了点悄悄话。）",
                                '<25>{#p/alphys}{#f/2}* ...',
                                "<25>{#p/alphys}{#g/alphysNervousLaugh}* 呃... 你-你...\n  真那样做了？？",
                                "<32>{#p/human}* （你又跟Alphys说了点悄悄话。）",
            ...
            c_aa_deathbed: () =>
                SAVE.data.b.svr
                    ? [
                        ['<25>{#p/asriel1}{#f/13}* ...'],
                        [
                            "<25>{#p/asriel1}{#f/23}* ...没事的，Frisk。",
                            "<25>{#f/13}* 即使那家伙不会回来...",
                            "<25>{#f/17}* 我们也将永远铭记\n  我们共同的朋友\n  为我们所做的一切。"
                        ],
                        ['<25>{#p/asriel1}{#f/13}* Frisk...', '<25>{#f/17}* 时候不早了，\n  我们也该去做\n  更有意义的事了。']
