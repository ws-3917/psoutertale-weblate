...
export default {
    a_starton: {
        telescope1: () => [
            ...(SAVE.data.b.svr ? [] : ['<32>{#p/basic}* Un telescopio de largo alcance de la Capital, creado en el año 261X.']),
        ...
        shockpapyrus0a: [
            '<15>{#p/papyrus}{#e/papyrus/27}¿¿QUÉ EN KRIOS ESTÁ PASANDO AQUÍ??',
        ...
        shockpapyrus1: () =>
            [
                [
                    ...
                    choicer.create('* (¿Qué debería hacer Asriel?)', 'Perdonar', 'Actuar', 'Magia', 'Luchar')
                ],
        ...
        fast_food1: () => [
            SAVE.data.b.fryz
                ...
                : '<32>{#p/human}{#npc}* (Tienes los Deslizadores.)'
        ],
        ...
        bunbun: pager.create(
            ...
            () =>
                SAVE.data.n.plot === 72
                    ? ["<32>{#p/basic}* Mamá dice que pronto iremos a un nuevo hogar natal.", "<32>* ... ¿qué es un hogar natal?"]
                    : [
            ...
            () =>
                SAVE.data.n.plot === 72
                    ? ['<32>{#p/basic}* ¿Los humanos tienen un hogar natal?']
        ...
        bedbook5: [
            ...
            '<32>* \"Entonces, un día fatídico, se disparó un arma enorme contra el hogar natal de los monstruos.\"',
        ...
        beddoor3: ['<32>{#p/basic}{#npc/a}* ¡Lo siento, gatito!\n* ¡No quedan más vacantes aquí!'],
        candy1: () =>
            postSIGMA()
                ...
                : [
                    ...
                    choicer.create('* (Comprar las Exobayas por 8 de Oro?)', 'Sí', 'No')
                ],
        candy2: ["<32>{#p/human}* (No tienes suficiente Oro.)"],
        candy3: ["<32>{#p/human}* (Llevas demasiado encima.)"],
        candy4: ['<32>{#p/human}* (Conseguiste las Exobayas.)'],
        candy5: ['<32>{#p/human}* (Decidiste no comprar.)'],
        capstation1: [
            '<32>{#p/human}* (Miras detrás de la estación y encuentras una llave.)',
            '<32>{#s/equip}{#p/human}* (La Llave Oxidada ha sido añadida a tu llavero.)',
            '<32>* (Revisa tu TELÉFONO para ver todas las llaves conseguidas)'
        ],
        capstation2: ['<32>{#p/human}* (Miras detrás de la estación.)', '<32>{#p/basic}* Nada nuevo por aquí.'],
        crossword0: () =>
            world.edgy
                ? [
                    '<25>{#p/sans}* oh, hola.',
                    '<25>{#p/sans}{#f/2}* si te gustó el último puzzle, espera a ver este.'
                ]
                : [
                    '<18>{#p/papyrus}{#f/9}¡¡HUMANO!!',
                    '<18>{#f/9}YA VISTE MIS PUZZLES.',
                    '<18>{#f/4}PERO LO QUE ESTÁS A PUNTO DE VER ES...'
                ],
        crossword1: () =>
            world.edgy
                ? [
                    '<26>{#p/sans}* no, de hecho.\n* acércate y echa un vistazo.',
                    "<25>{#p/sans}* está justo ahí, en el suelo."
                ]
                : [
                    "<18>{#p/papyrus}{#f/7}¡¡SANS!!\n¿¡DONDE ESTA EL PUZZLE!?",
                    "<25>{#p/sans}* lo estás viendo justo ahora.",
                    '<18>{#p/papyrus}{#f/1}¿QUÉ?\n¿ESA TABLETA TIRADA EN EL SUELO?',
                    '<18>{#f/4}ESTA BIEN...'
                ],
        crossword2: (check: boolean) =>
            world.edgy
                ? [
                    check
                        ? '<25>{#p/sans}* bueno, ¿cómo te fue?\n* ... ¿demasiado caliente para manejarlo?'
                        : "<25>{#p/sans}* ni siquiera te atreves a mirarlo, ¿eh?",
                    "<25>* supongo que no debería de haber esperado mucho.",
                    '<26>{#f/3}* bueno.\n* quizás un puzle kakuro sería más fácil para ti.',
                    '<26>{#f/0}* pero no sé.'
                ]
                : [
                    check
                    ...
                    '<25>{#p/sans}* ups.',
                    "<25>{#f/3}* sabía que debería de haber usado el puzle kakuro diario.",
                    '<18>{#p/papyrus}{#f/1}¿¡QUÉ!? ¿¡KAKURO!?',
                    "<18>{#f/9}¡¡NO ME PUEDO CREER QUE HAYAS DICHO ESO!!",
                    '<18>{#f/4}EN MI OPINIÓN...',
                    '<18>{#f/0}SUDOKU FÁCILMENTE ES MÁS DIFÍCIL.',
                    '<25>{#p/sans}* ¿qué? enserio, ¿hermano?\n* ¿esa super fácil mezcla de números?',
                    "<25>{#f/4}* eso es para huesos bebés.",
                    '<18>{#p/papyrus}{#f/4}IN. CREÍBLE.',
                    '<18>{#f/9}¡¡¡HUMANO!!!\n¡RESUELVE ESTA DISCUSIÓN!',
                    choicer.create('* (¿Cuál es más difícil?)', 'Sudoku', 'Kakuro')
                ],
        crossword3a: [
            '<18>{#p/papyrus}¡JA! ¡JA! ¡SÍ!',
            '<18>¡LOS HUMANOS DEBEN DE SER MUY INTELIGENTES!',
            '<18>¡SI ELLOS TAMBIÉN CREEN QUE EL SUDOKU ES DIFÍCIL!',
            '<18>{#f/9}¡NYE! ¡JE! ¡JE ¡JE!'
        ],
        crossword3b: [
            '<18>{#p/papyrus}{#f/9}¡VOSOTROS DOS SOIS RAROS!',
            '<18>{#f/0}KAKURO PUZLES SON TAN FÁCILES.',
            "<18>SIEMPRE ES LA MISMA SOLUCIÓN.",
            '<18>{#f/4}SIMPLEMENTE RELLENO TODOS LOS ESPACIOS CON LA LETRA \"Z\"...',
            '<18>{#f/4}PORQUE CADA VEZ QUE MIRO UN KAKURO...',
            '<18>{#f/9}¡¡¡TODO LO QUE PUEDO HACER ES RONCAR!!!'
        ],
        crossword3c: [
            '<25>{#p/sans}{#f/3}* por cierto, creo que vi una pareja de perros corriendo por aquí...',
            "<25>{#f/0}* yo andaría con cuidado si fuera tú."
        ],
        crossword4a: pager.create(0, ['<25>{#p/sans}* ey, ¿a dónde vas, muchacho?'], ['<25>{#p/sans}* camino equivocado.']),
        crossword4b: pager.create(0, ["<25>{#p/sans}* ¿de verdad?\n* no es TAN malo."], ['<25>{#p/sans}* ¿de verdad?']),
        crossword5a: [
            '<25>{#p/sans}* gracias por decir \"sudoku\" sólo para calmar a mi hermano.',
            '<25>{#f/4}* ayer se quedó bloqueado intentado \"resolver\" un mapa estelar.'
        ],
        crossword5b: [
            '<25>{#p/sans}* papyrus...\n* ... encuentra dificultad en lugares interesantes.',
            '<25>{#f/4}* ayer se quedó bloqueado intentado \"resolver\" un mapa estelar.'
        ],
        crossword6a: [
            "<25>{#p/sans}{#f/3}* me imaginé que te lo saltarías.",
            "<25>{#f/0}* es que eso se ve como el tipo de cosa que harías tú, ¿no?"
        ],
        crossword6b: [
            "<25>{#p/sans}{#f/3}* estoy sorprendido.\n* pensé que pasarías de largo.",
            "<25>{#f/2}* quizás no eres tan malo después de todo."
        ],
        crossword6c: ['<25>{#p/sans}{#f/2}* jejej, te hice mirar.'],
        crossword6d: [
            "<25>{#p/sans}{#f/3}* estoy sorprendido.\n* pensé que ni estarías interesado.",
            "<25>{#f/2}* quizás no eres tan malo después de todo."
        ],
        doggo1: [
            '<32>{#p/basic}* ¿Algo se ha movido?\n* ¿Ha sido mi imaginación?',
            '<32>* Si algo SE HA movido...\n* Por ejemplo, un humano...',
            "<32>* ¡Me aseguraré que nunca salga de mi vista otra vez!"
        ],
        doggo2: [
            [
                "<32>{#p/basic}* A-A-Algo me acarició...\n* ¡Algo que no se está m-m-moviendo...!",
                "<32>* Voy a necesitar algunas galletas de perro para esto."
            ],
            ['<32>{#p/basic}* ¡¿¡¿Una l-l-llave inglesa apareció de la nada, q-qué!?!?', '<32>{#p/basic}* ... vaya día!'],
            [],
            [
                '<32>{#p/basic}* Un h-h-humano vino y me atacó...\n* ¡De la n-n-nada...!',
                "<32>{#p/basic}* Voy a...\n* Me voy a la cama."
            ]
        ],
        doggo3: pager.create(
            0,
            ['<32>{#p/basic}* ¿Hola?\n* ¿Hay alguien ahí...?'],
            ['<32>{#p/basic}* ¿Me están jugando una broma los dos?\n* Muy gracioso, chicos.'],
            ['<32>{#p/basic}* ¿Grandote?\n* ¿Eres tú?\n* Vamos...'],
            ["<32>{#p/basic}* Bueno, no es ese esqueleto grande...\n* El es muy ruidoso."],
            ['<32>{#p/basic}* Seas quien seas, ¡¡¡ya para!!!'],
            ['<32>{#p/basic}* ...']
        ),
        doggo3x: ['<32>{#p/basic}* (Ronquido... ronquido...)'],
        drop_chip: [
            '<32>{#p/basic}* Tú acabas de...\n* ¿Tirar la parte mía que te dí?',
            '<32>* No tengo nada que decirte...\n* ¡Vete!'
        ],
        drop_cream: ["<32>{#p/basic}* Sabes, tienes suerte que estoy ocupado haciendo publicidad."],
        eat_chip: [
        ...
        genotext: {
            ...
            papyrusSolo4c: ['<18>{#p/papyrus}{#f/31}YO...', '<18>{#f/3}... NO...'],
            papyrusSolo4d: [
        ...
        objinter: {
            ...
            microwave2: () =>
                SAVE.data.b.svr
                    ...
                    : ['<32>{#p/human}* (You look behind the microwave...)', '<32>{#p/basic}* Nada nuevo por aquí.'],
            microwave3: () =>
                SAVE.data.b.svr
        ...
        papcomputer5: () =>
            world.runaway
                ...
                : SAVE.data.n.plot === 72
                    ? ['PERDÓN', "BUT WE'RE", 'OFFLINE', 'LMAO']
                    : ['REFRESH', 'MENSAJES', 'AJUSTES', 'LOG OUT'],
        papcouch0: () =>
            SAVE.data.b.svr
        ...
        papsink6: ['<18>{#p/papyrus}{#f/4}AND NOW THE DOG HAS DISAPPEARED WITH MY ATTACK.', '<18>OH BUENO...'],
        papsolu1: [
        ...
        papyrus8: [
            '<18>{#p/papyrus}{#f/9}BIEN... ENTONCES...',
        ...
        papyrusFinal4: (b: boolean) =>
            world.edgy || world.killed0
                ...
                : [
                    ...
                    choicer.create('* (How will you respond?)', "Let's be\nfriends", 'What a\nloser')
                ],
        ...
        papyrusFinal7a: ['<18>{#p/papyrus}{#f/31}...\nESTA BIEN...', "<18>{#f/3}I GUESS I'LL ACCEPT MY FAILURE."],
    ...
    b_opponent_papyrus: {
        ...
        death2: () =>
            world.genocide
                ? ['<15>{#p/papyrus}{#f/21}SANS, YO...', '<15>{#f/33}{@random=1.1/1.1}I FAILED YOU...']
                : papreal()
                    ? [
            ...
            () =>
                SAVE.data.n.plot === 72
                    ...
                    : SAVE.data.b.a_state_napstadecline
                        ? ['<32>{#p/napstablook}{#k/2}* eh...', '<32>{#p/napstablook}{#k/2}* hey there...']
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/4}ESTA BIEN, ESTA BIEN...',
