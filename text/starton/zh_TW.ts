...
export default {
    a_starton: {
                        ...
                        : SAVE.data.n.plot === 33
                            ...
                            : SAVE.data.n.plot === 72
                                ? [
                                    ...
                                    '<32>* ...是個叫「ONIONSAN」的打來的。',
                                    "<32>* 不過這人沒有給我留言。"
                                ]
                                : papreal()
                                    ? ['<32>{#p/basic}{#npc/a}* 你知道Sans在哪兒嗎？']
                                    : [
                    ...
                    ? [
                        ...
                        SAVE.data.n.state_starton_doggo === 2 && SAVE.data.n.state_starton_greatdog === 2
                            ...
                            : SAVE.data.n.state_starton_doggo === 2
                                ? '<32>{#p/basic}{#npc/a}* 我還是在想Doggo發生了什麼事。'
                    ...
                    : SAVE.data.n.plot === 33
                        ...
                        : SAVE.data.n.plot === 72
                            ...
                            : SAVE.data.n.state_starton_doggo === 2 && SAVE.data.n.state_starton_greatdog === 2
                                ...
                                : SAVE.data.n.state_starton_doggo === 2
                                    ? ["<32>{#p/basic}{#npc/a}* 我不敢相信Doggo居然失蹤了..."]
                                    : SAVE.data.n.state_starton_greatdog === 2
            ...
            g_dogaressa: () =>
                SAVE.data.b.killed_mettaton
                    ? [
                        ...
                        "<32>{#p/basic}{#npc/a}* （Mettaton的死是個悲劇，\n  但他只是個電視人物而已！）"
                    ]
                    : SAVE.data.n.plot === 33
                        ...
                        : SAVE.data.n.plot === 33
                            ...
                            : SAVE.data.n.plot === 72
                                ? [
                                    ...
                                    ...(world.population < 4
                                        ? [
                                            "<32>{#npc/a}* Grillbz說他相當樂意。",
                                            '<33>* 他肯定還在怕你呢。'
                                        ]
                                        : ["<32>{#npc/a}* Grillbz說他會考慮的。"])
                                ]
                                : papreal()
                                    ? [
                                        '<32>{#p/basic}{#npc/a}* Grillby越來越緊張了。',
                                        "<32>* Sans是他的頭號常客，\n  今天卻一直沒出現..."
                                    ]
                                    : world.dead_dog
                                        ? [
        ...
        papspaghet1a: () => [
            ...
            "<18>{#f/0}你帶著它呢！！",
            '<18>{#f/9}人類，你怎麼打算的？',
            choicer.create("* （你要拿Papyrus的意面怎麼辦呢？）", '一起吃', '自己獨享'),
            '<18>{#p/papyrus}真的！？'
        ],
        papspaghet2a: [
            "<18>{#f/5}你忍著沒吃\n我做的義大利麵...",
...
'<18>因為我，\n偉大的PAPYRUS...',
            ...
            ...(SAVE.data.b.svr
                ? [
                    ...
                    [
                        ...
                        '<25>{#f/17}* 但他還是我行我素... \n  致力於自己的小科研\n  而無心出岫。',
                        "<25>{#f/13}* Papyrus他真的好像進入了\n  一種超凡脫俗的境界。"
                    ],
                    [
                        '<26>{#p/asriel1}{#f/13}* Papyrus曾創造出\n  一把存在於傳說中的\n  名為「鶴嘴斧」的工具。',
                        '<25>{#f/17}* 一件多功能工具，\n  可以斬斷任何材料。',
                        '<25>{#f/15}* 其耐久度為...\n  永不磨損。',
                        '<25>{#f/13}* 但他卻把它扔掉了，\n  用他自己的話來說...',
                        '<25>{#f/13}* 「擁有一個萬能工具\n   會使工作失去樂趣！」'
                    ],
                    ['<26>{#p/asriel1}{#f/20}* 所以Papyrus擁有一個\n  獨特的思維方式。']
            ...
            SAVE.data.b.svr
                ...
                : world.darker
                    ...
                    : SAVE.data.n.plot < 31
                        ...
                        : SAVE.data.n.plot === 72
                            ? ["<32>{#p/basic}* Sans的哨站...", "<32>* 這項投資的質量一點都沒有改變。"]
                            : ["<32>{#p/basic}* Sans的哨站...", '<33>* 事後看來，這真是\n  一項糟糕的投資。'],
        ...
        trivia: {
            ...
            ntower: () =>
                SAVE.data.b.svr
                    ? [
                        [
                            '<25>{#p/asriel1}{#f/13}* 我覺得Alphys大概\n  永遠不會修理這個了。',
                            "<25>{#f/16}* 當然我不怪她。\n* 畢竟這東西的規則\n  簡直像個惡夢。",
                            '<25>{#f/20}* 同樣的，\n  執行這個謎題也需要Sans。',
                            '<25>{#f/15}* 不過讓他參與這個謎題... \n  估計不太可能。'
                        ],
                        [
                            '<25>{#p/asriel1}{#f/17}* 對... Sans...\n* 風趣橫生，但不咋活躍。',
                            '<25>{#f/13}* 不咋「活躍」，\n  自然代表「身體」的不活躍。',
                            "<25>{#f/15}* 而「身體」不活躍，\n  意思就是說\n  他幾乎不咋「移動」。",
                            '<25>{#f/16}* 最後不咋「移動」，\n  就是說他從頭到晚\n  都不會起來走一步路。',
                            '<25>{#f/13}* 是的。\n* 除了他走捷徑的時候。',
            ...
            s_backrooms_lessdog: () =>
                SAVE.data.b.svr
                    ? [
                        ...
                        ...[
                            ['<25>{#p/asriel1}{#f/13}* Frisk，你在幹啥？'],
                            ["<25>{#p/asriel1}{#f/13}* Frisk，這裡什麼都沒有。"],
            ...
            s_bh_stove: pager.create(
                ...
                () =>
                    SAVE.data.b.svr
                        ? [
                            [
                                '<25>{#p/asriel1}{#f/13}* Frisk，我想問一下...',
                                '<25>{#f/13}* 你聽說過被遺棄的\n  芝士蛋糕的悲劇嗎？',
                                '<25>{#f/16}* 就在這個烤盤裡，\n  一個甜點被創造出來...',
                                '<25>{#f/3}* 這讓烘焙師感到出乎意料。'
                            ],
                            [
                                '<25>{#p/asriel1}{#f/3}* 看，Sans創造出了一個\n  多麼甜蜜的芝士蛋糕啊...',
                                '<25>{#f/4}* 任何嘗過這個蛋糕的人，\n  都將對其感到無法自拔。',
                                '<25>{#f/15}* 只要他願意，\n  他的顧客將會遍布前哨站\n  的任何一個區域。'
                            ],
                            [
    ...
    b_group_starton: {
        ...
        stardrakeSpacetop: () =>
            world.goatbro
                ...
                : SAVE.data.b.s_state_chilldrake
                    ? ['<32>{#p/story}* Chilldrake和Astro Serf擺著姿勢，\n  扮作大反派。']
                    : ['<32>{#p/story}* Stardrake和Astro Serf擺著姿勢，\n  扮作大反派。'],
        stardrakeSpacetop2a: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 只剩一個了。']
                : SAVE.data.b.s_state_chilldrake
        ...
        stardrakeSpacetop2b: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 只剩一個了。'] : ['<32>{#p/story}* Astro Serf泰然自若。'],
        stardrakeSpacetop2c: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 只剩一個了。'] : ['<32>{#p/story}* 只剩下「Astro Serf」了。'],
        stardrakeSpacetop2d: () => (world.goatbro ? ['<32>{#p/asriel2}* Jerry。'] : ['<32>{#p/story}* Jerry。']),
        stardrakeSpacetopJerry: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 笨蛋青年兩人組。\n* 再加一個，Jerry。']
                : SAVE.data.b.spared_jerry
                    ? ['<32>{#p/story}* Jerry和朋友們出現了！']
                    : SAVE.data.b.s_state_chilldrake
        ...
        stardrakeSpacetopJerry2b: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 還剩下兩個。'] : ['<32>{#p/story}* Astro Serf泰然自若。\n* Jerry.'],
    ...
    b_opponent_stardrake: {
        ...
        act_check2: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* CHILLDRAKE - 攻擊12 防禦7\n* 看啥都要對著幹！！\n* 他在找逃跑路線。']
                : ["<32>{#p/story}* STARDRAKE - 攻擊12 防禦7\n* 想跟你打趣，\n  但被打得沒趣了。"],
        act_check3: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* CHILLDRAKE - 攻擊12 防禦7\n* 看啥都要對著幹！！\n* 尤其是調情！！']
        ...
        heckleText1: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/human}* (你譴責Chilldrake的行為。）']
                : ['<32>{#p/human}* （你對Stardrake喝倒彩。）'],
        heckleText2: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/human}* （你鼓勵Chilldrake\n  去其他地方當反叛者。）']
                : ["<32>{#p/human}* （你說Stardrake\n  沒有一點幽默細胞。）"],
        heckleText3: () =>
            SAVE.data.b.s_state_chilldrake
                ? [
                    '<32>{#p/human}* （你嘲笑Chilldrake\n  在鳥不拉屎的地方抗議。）',
                    '<32>{#p/basic}* Chilldrake將你的嘲諷當做建議，\n  溜達著去鎮上了。'
                ]
                : [
        ...
        jokeText0: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/human}* （你認同了Chilldrake。）']
                : ["<32>{#p/human}* （你對Stardrake的言論回以大笑。）"],
        jokeText1: () =>
            SAVE.data.b.s_state_chilldrake
        ...
        randStatus1: () =>
            SAVE.data.b.s_state_chilldrake
                ...
                : ['<32>{#p/story}* Stardrake正在審視人群。'],
        randStatus2: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* Chilldrake正在吟唱\n  無政府主義的咒語。']
                : ['<32>{#p/story}* Stardrake正在練習下一個雙關。'],
        randStatus3: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* Chilldrake著手著一場\n  怪物暴動。']
    ...
    b_opponent_jerry: {
        ...
        act_flirt: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/human}* （你向Jerry調情。）\n* （它感謝你的讚美。）']
                : 5 <= world.flirt
                    ? ['<32>{#p/human}* （你調用你的經驗，\n  發出一場改變人生的調情。）']
                    : [
                        '<32>{#p/human}* （你向Jerry調情。）',
                        '<32>{#p/basic}* Jerry有點喜歡你了...\n  好像過頭了。'
                    ],
        act_ditch: () => ['<32>{#p/human}* （你甩掉了Jerry。）'],
        act_kiss: () => ['<32>{#p/human}* （你親吻了Jerry。）'],
        flirtStatus: ["<32>{#p/story}* Jerry的救贖之旅開始了。"],
        ...
        randStatus1: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* Jerry的生活無憂無慮。']
                : ['<32>{#p/story}* Jerry吃著粉狀的食物，\n  自豪地舔著手。'],
        randStatus2: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* Jerry嚕嚕地笑著。']
                : ['<32>{#p/story}* Jerry打噴嚏時\n  的粘液飛的到處都是。'],
        randStatus3: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* Jerry發出一聲興奮的尖叫。']
                : ['<32>{#p/story}* Jerry打了個哈欠。'],
        randStatus4: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* 聞起來像... Jerry？']
                : ['<32>{#p/story}* 聞起來像... Jerry。'],
        status1: ['<32>{#p/story}* Jerry纏上你了！'],
    ...
    b_opponent_mouse: {
        ...
        act_direct3: ["<32>{#p/human}* （你嘗試告訴Whizkarat更多，\n  但它已經找到了適合\n  自己的生活方式。）"],
        act_disown: [
        ...
        name: '* Whizkarat',
        randStatus1: ['<32>{#p/story}* Whizkarat幻想著四肢著地。'],
        randStatus2: ['<32>{#p/story}* Whizkarat正在掃描這個區域。'],
        ...
        safeStatus: () =>
            world.goatbro ? ["<32>{#p/asriel2}* 不堪一擊。"] : ['<32>{#p/story}* Whizkarat前程無量。'],
    ...
    b_opponent_doggo: {
        ...
        name: '* Doggo',
        fetchStatus: ['<32>{#p/story}* Doggo喜歡玩拋接遊戲！'],
    ...
    b_opponent_lesserdog: {
        ...
        act_check4: ['<32>{#p/story}* CANIS MINOR - 攻擊12 防禦2\n* 為破譯你發出的\n  愛的密碼而付出全力。'],
        act_check5: ['<32>{#p/story}* CANIS MINOR - 攻擊12 防禦2\n* 這隻小狗的旅程才剛剛開始。'],
        ...
        fetchStatus: ['<32>{#p/story}* Canis Minor喜歡玩拋接遊戲！'],
    ...
    b_opponent_dogaressa: {
        act_check: () =>
            world.goatbro
                ...
                : ['<32>{#p/story}* DOGARESSA - 攻擊14 防禦5\n* 這隻小狗認為她丈夫很可愛。\n  僅限於氣味的那種？'],
        act_check2: ['<32>{#p/story}* DOGARESSA -  攻擊14 防禦5\n* 這隻小狗非常想念她的老公\n  僅限於被殺掉後的那種？'],
        act_check3: ['<32>{#p/story}* DOGARESSA - 攻擊14 防禦5\n* 對這隻小狗來說\n  事態進展得很順利。'],
        act_check4: [
            "<32>{#p/story}* DOGARESSA - 攻擊14 防禦5\n* 這隻小狗發覺可愛的東西\n  不只有她老公。"
        ],
        act_check5: ["<32>{#p/story}* DOGAMY - 攻擊14 防禦5\n* 這隻小狗在為她老公的安危擔憂。"],
    ...
    b_opponent_greatdog: {
        act_check: () =>
            world.goatbro
                ...
                : ["<32>{#p/story}* CANIS MAJOR - 攻擊15 防禦8\n* 太過興奮，以至於將\n  戰鬥當作兒戲。"],
        act_check2: ['<32>{#p/story}* CANIS MAJOR - 攻擊15 防禦8\n* 渴望著關愛與照顧...'],
        act_check3: ['<32>{#p/story}* CANIS MAJOR - 攻擊15 防禦8\n* 已經累到虛脫了。'],
        act_flirt: [
        ...
        name: '* Canis Major',
        fetchStatus: ['<32>{#p/story}* Canis Major喜歡玩拋接遊戲！'],
        petStatus1: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Canis Major。']
    ...
    b_opponent_papyrus: {
        ...
        flirtStatus8: ['<32>{#p/story}* Papyrus往他耳後抹了點\n  MTT牌可愛汁。'],
        ...
        spaghetti2: ["<32>{#p/basic}* 要不是Papyrus現在忙於戰鬥，\n  他大概就注意到了。"],
    ...
    i_fryz: {
        ...
        drop: ["<32>{#p/human}* （你把烈焰Grillby當做燃燒瓶\n  拋了出去。）"],
        info: () =>
            SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
                ? ['<32>{#p/human}* （30 HP。）']
                : ['<32>{#p/basic}* 「烈焰Grillby」 回復30 HP\n* 這次可不只是「暖暖的」了喔。'],
        name: "烈焰Grillby",
                ...
                SAVE.data.n.plot === 72
                    ...
                    : 65 <= SAVE.data.n.plot
                        ? SAVE.data.b.a_state_hapstablook
                            ? 68 <= SAVE.data.n.plot
                                ? [
                                    '<32>{#p/napstablook}{#k/3}* 嘿，mettaton剛剛來過',
                                    "<32>{#k/0}* 我們聊了一些以前的家常...",
                            ...
                            : 60 <= SAVE.data.n.plot
                                ? SAVE.data.b.a_state_napstadecline
                                    ...
                                    : [
                                        '<32>{#k/1}* 喔... 對...',
                                        '<32>{#k/3}* 謝謝你同意\n  幫助我去做那件事',
                                        "<32>{#k/2}* mettaton最近的行為有點奇怪...",
                                        "<32>{#k/0}* 但他這麼做\n  我一點都不驚訝",
                                        '<32>{#k/4}* alphys前陣子第一次帶我看\n  喵喵太空探險系列的電影...',
        ...
        s_town1: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        "<25>{#p/undyne}{#f/14}* ...他喜歡Grillby's的\n  美味新品！",
                        '<18>{#p/papyrus}{#f/4}什麼？\n美味新品？',
        ...
        s_backrooms: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ? []
                    : [
                        "<25>{#p/undyne}{#f/1}* 這不是Canis Minor\n  平時喜歡待的地方嗎？",
        ...
        f_sans: pager.create(
            ...
            () =>
                solo()
                    ...
                    : [
                        "<18>{#p/papyrus}{#f/5}就連UNDYNE都被SANS的\n壞習慣影響了...",
            ...
            () =>
                solo()
                    ...
                    : [
                        ...
                        "<18>{#p/papyrus}{#f/0}UNDYNE其實不是真的想\n偷你的東西的。",
        ...
        f_story1: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ? []
                    : [
                        "<25>{#p/undyne}{#f/12}* 所以我想傳給Alphys資訊的\n  計畫才失敗了的。",
                        '<18>{#p/papyrus}{#f/6}你用訊星給ALPHYS傳過\n信！？',
                        '<18>{#p/papyrus}{#f/5}噢...\nUNDYNE...',
                        "<25>{#p/undyne}{#f/17}* 怎麼？\n* 我就還以為它知道要給誰\n  說呢！",
        ...
        f_path: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ? []
                    : [
                        '<25>{#p/undyne}{#f/12}* 可能這就是Alphys總說的\n  「空間扭曲」現象吧。',
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<25>{#p/undyne}{#f/10}* 又或是Terrestria對\n  「宇宙之美」的痴迷...',
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/6}但是，\n誰都有不如意的時候嘛。',
                        '<25>{#p/undyne}{#f/14}* 你這個「誰」包括Papyrus嗎？',
                    ...
                    ? [
                        ...
                        ...(solo()
                            ...
                            : [
                                ...
                                "<25>{#p/undyne}{#f/17}* 你應該提醒我的，Papyrus！！\n* 我現在沒退路了！",
        ...
        a_mettaton2: pager.create(
            ...
            () => [
                ...
                ...(SAVE.data.n.plot < 60
                    ...
                    : [
                        '<18>{#p/papyrus}{#f/4}METTATON想讓我上，可...',
