...
export default {
    a_starton: {
        ...
        npcinter: {
                        ...
                        : SAVE.data.n.plot === 33
                            ...
                            : SAVE.data.n.plot === 72
                                ? [
                                    ...
                                    '<32>* ...是个叫“ONIONSAN”的打来的。',
                                    "<32>* 不过这人没有给我留言。"
                                ]
                                : papreal()
                                    ? ['<32>{#p/basic}{#npc/a}* 你知道Sans在哪儿吗？']
                                    : [
            ...
            g_bunbun: pager.create(
                ...
                () =>
                    SAVE.data.b.killed_mettaton
                        ? [
                            '<32>{#p/basic}{#npc/a}* M-mettaton是这里\n  最-最烧的帅哥了...',
                            '<32>* 没有他，\n  前哨站冷清了好多好多！'
                        ]
                        : SAVE.data.n.plot === 33
                            ? [
                    ...
                    ? [
                        ...
                        SAVE.data.n.state_starton_doggo === 2 && SAVE.data.n.state_starton_greatdog === 2
                            ...
                            : SAVE.data.n.state_starton_doggo === 2
                                ? '<32>{#p/basic}{#npc/a}* 我还是在想Doggo发生了什么事。'
                    ...
                    : SAVE.data.n.plot === 33
                        ...
                        : SAVE.data.n.plot === 72
                            ...
                            : SAVE.data.n.state_starton_doggo === 2 && SAVE.data.n.state_starton_greatdog === 2
                                ...
                                : SAVE.data.n.state_starton_doggo === 2
                                    ? ["<32>{#p/basic}{#npc/a}* 我不敢相信Doggo居然失踪了..."]
                                    : SAVE.data.n.state_starton_greatdog === 2
                                        ? ["<32>{#p/basic}{#npc/a}* 那个大家伙去哪了？\n* 它不来我们没法开始玩啊。"]
                                        : papreal()
                                            ? ["<32>{#p/basic}{#npc/a}* Sans去哪了...\n* 他本应该来摸我的头的..."]
                                            : [
            ...
            g_dogaressa: () =>
                SAVE.data.b.killed_mettaton
                    ? [
                        ...
                        "<32>{#p/basic}{#npc/a}* （Mettaton的死是个悲剧，\n  但他只是个电视人物而已！）"
                    ]
                    : SAVE.data.n.plot === 33
                        ...
                        : SAVE.data.n.plot === 72
                            ...
                            : SAVE.data.n.state_starton_doggo === 2 && SAVE.data.n.state_starton_greatdog === 2
                                ...
                                : SAVE.data.n.state_starton_doggo === 2
                                    ? ["<32>{#p/basic}{#npc/a}* （Doggo去哪了？）\n* （希望他这回没有迷路。）"]
                                    : SAVE.data.n.state_starton_greatdog === 2
                                        ? ["<32>{#p/basic}{#npc/a}* （Canis Major去哪了？）\n* （他本应该在这里\n  和我们一起玩游戏的。）"]
                                        : papreal()
            ...
            g_doggo: () =>
                SAVE.data.b.killed_mettaton
                    ? [
                        '<32>{#p/basic}{#npc/a}* 失去Mettaton真是太糟糕了，\n  你能懂吗？',
                        '<33>* 整个前哨站里，\n  就他最震天动地了！',
                        "<32>* 没有他，电视上可能就\n  只会出现那些动都不动的人了。"
                    ]
                    : SAVE.data.n.plot === 33
                        ...
                        : SAVE.data.n.plot === 33
                            ...
                            : SAVE.data.n.plot === 72
                                ? [
                                    ...
                                    ...(world.population < 4
                                        ? [
                                            "<32>{#npc/a}* Grillbz说他相当乐意。",
                                            '<33>* 他肯定还在怕你呢。'
                                        ]
                                        : ["<32>{#npc/a}* Grillbz说他会考虑的。"])
                                ]
                                : papreal()
                                    ? [
                                        '<32>{#p/basic}{#npc/a}* Grillby越来越紧张了。',
                                        "<32>* Sans是他的头号常客，\n  今天却一直没出现..."
                                    ]
                                    : world.dead_dog
                                        ? [
            ...
            t_imafraidjumitebeinagang: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ? [
                            "<32>{#p/basic}{#npc/a}* 我去找了找Papyrus，\n  想问问他的棉丝收藏是哪来的，\n  结果他说他会帮我也弄一些！",
                            "<32>* 他真是棒极了不是吗？"
                        ]
                        : SAVE.data.b.killed_mettaton
                            ? [
                                "<32>{#p/basic}{#npc/a}* 我的MTT牌牙刷又坏了，\n  这次我还修不好一点。",
                                "<32>* ...结果他们现在还不再生产了。"
                            ]
                            : papreal()
                                ? [
                                ...
                                : world.popmax(0) - world.population > 4
                                    ? [
                                        "<32>{#p/basic}{#npc/a}* 我可以借你我的MTT牌牙刷...",
                                        "<32>* ...不过我感觉\n  你会把它弄得粉碎。"
                                    ]
                                    : [
                                        "<32>{#p/basic}{#npc/a}* MTT牌牙刷的质量\n  也太他娘的差了。",
                                        '<32>* 我还没来得及开始刷，\n  东西就被我捏碎了！'
                                    ],
                () =>
                    SAVE.data.n.plot === 72
        ...
        paproom2: ['<18>{#p/papyrus}{#f/4}SANS是不是教了你\n走什么捷径...？'],
        ...
        papspaghet1a: () => [
            ...
            "<18>{#f/0}你带着它呢！！",
            '<18>{#f/9}人类，你怎么打算的？',
            choicer.create("* （你要拿Papyrus的意面怎么办呢？）", '一起吃', '自己独享'),
            '<18>{#p/papyrus}真的！？'
        ],
        papspaghet2a: [
            "<18>{#f/5}你忍着没吃\n我做的意大利面...",
...
'<18>因为我，\n伟大的PAPYRUS...',
            ...
            ...(SAVE.data.b.svr
                ? [
                    ...
                    [
                        ...
                        '<25>{#f/17}* 但他还是我行我素... \n  致力于自己的小科研\n  而无心出岫。',
                        "<25>{#f/13}* Papyrus他真的好像进入了\n  一种超凡脱俗的境界。"
                    ],
                    [
                        '<26>{#p/asriel1}{#f/13}* Papyrus曾创造出\n  一把存在于传说中的\n  名为“鹤嘴斧”的工具。',
                        '<25>{#f/17}* 一件多功能工具，\n  可以斩断任何材料。',
                        '<25>{#f/15}* 其耐久度为...\n  永不磨损。',
                        '<25>{#f/13}* 但他却把它扔掉了，\n  用他自己的话来说...',
                        '<25>{#f/13}* “拥有一个万能工具\n   会使工作失去乐趣！”'
                    ],
                    ['<26>{#p/asriel1}{#f/20}* 所以Papyrus拥有一个\n  独特的思维方式。']
            ...
            SAVE.data.b.svr
                ...
                : world.darker
                    ...
                    : SAVE.data.n.plot < 31
                        ...
                        : SAVE.data.n.plot === 72
                            ? ["<32>{#p/basic}* Sans的哨站...", "<32>* 这项投资的质量一点都没有改变。"]
                            : ["<32>{#p/basic}* Sans的哨站...", '<33>* 事后看来，这真是\n  一项糟糕的投资。'],
        ...
        trivia: {
            ...
            ntower: () =>
                SAVE.data.b.svr
                    ? [
                        [
                            '<25>{#p/asriel1}{#f/13}* 我觉得Alphys大概\n  永远不会修理这个了。',
                            "<25>{#f/16}* 当然我不怪她。\n* 毕竟这东西的规则\n  简直像个噩梦。",
                            '<25>{#f/20}* 同样的，\n  运行这个谜题也需要Sans。',
                            '<25>{#f/15}* 不过让他参与这个谜题... \n  估计不太可能。'
                        ],
                        [
                            '<25>{#p/asriel1}{#f/17}* 对... Sans...\n* 风趣横生，但不咋活跃。',
                            '<25>{#f/13}* 不咋“活跃”，\n  自然代表“身体”的不活跃。',
                            "<25>{#f/15}* 而“身体”不活跃，\n  意思就是说\n  他几乎不咋“移动”。",
                            '<25>{#f/16}* 最后不咋“移动”，\n  就是说他从头到晚\n  都不会起来走一步路。',
                            '<25>{#f/13}* 是的。\n* 除了他走捷径的时候。',
            ...
            s_backrooms_lessdog: () =>
                SAVE.data.b.svr
                    ? [
                        ...
                        ...[
                            ['<25>{#p/asriel1}{#f/13}* Frisk，你在干啥？'],
                            ["<25>{#p/asriel1}{#f/13}* Frisk，这里什么都没有。"],
            ...
            s_bh_stove: pager.create(
                ...
                () =>
                    SAVE.data.b.svr
                        ? [
                            [
                                '<25>{#p/asriel1}{#f/13}* Frisk，我想问一下...',
                                '<25>{#f/13}* 你听说过被遗弃的\n  芝士蛋糕的悲剧吗？',
                                '<25>{#f/16}* 就在这个烤盘里，\n  一个甜点被创造出来...',
                                '<25>{#f/3}* 这让烘焙师感到出乎意料。'
                            ],
                            [
                                '<25>{#p/asriel1}{#f/3}* 看，Sans创造出了一个\n  多么甜蜜的芝士蛋糕啊...',
                                '<25>{#f/4}* 任何尝过这个蛋糕的人，\n  都将对其感到无法自拔。',
                                '<25>{#f/15}* 只要他愿意，\n  他的顾客将会遍布前哨站\n  的任何一个区域。'
                            ],
                            [
    ...
    b_group_starton: {
        ...
        stardrakeSpacetop: () =>
            world.goatbro
                ...
                : SAVE.data.b.s_state_chilldrake
                    ? ['<32>{#p/story}* Chilldrake和Astro Serf摆着姿势，\n  扮作大反派。']
                    : ['<32>{#p/story}* Stardrake和Astro Serf摆着姿势，\n  扮作大反派。'],
        stardrakeSpacetop2a: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 只剩一个了。']
                : SAVE.data.b.s_state_chilldrake
                    ? ['<32>{#p/story}* Chilldrake泰然自若。']
                    : ['<32>{#p/story}* Stardrake泰然自若。'],
        stardrakeSpacetop2b: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 只剩一个了。'] : ['<32>{#p/story}* Astro Serf泰然自若。'],
        stardrakeSpacetop2c: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 只剩一个了。'] : ['<32>{#p/story}* 只剩下“Astro Serf”了。'],
        stardrakeSpacetop2d: () => (world.goatbro ? ['<32>{#p/asriel2}* Jerry。'] : ['<32>{#p/story}* Jerry。']),
        stardrakeSpacetopJerry: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 笨蛋青年两人组。\n* 再加一个，Jerry。']
                : SAVE.data.b.spared_jerry
                    ? ['<32>{#p/story}* Jerry和朋友们出现了！']
                    : SAVE.data.b.s_state_chilldrake
        ...
        stardrakeSpacetopJerry2b: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 还剩下两个。'] : ['<32>{#p/story}* Astro Serf泰然自若。\n* Jerry.'],
        stardrakeSpacetopJerry2c: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 还剩下两个。']
                : SAVE.data.b.s_state_chilldrake
                    ? SAVE.data.b.spared_jerry
                        ? ['<32>{#p/story}* Chilldrake和Jerry\n  不会为此产生任何情绪！']
                        : ['<32>{#p/story}* Chilldrake泰然自若。\n* Jerry。']
                    : SAVE.data.b.spared_jerry
                        ? ['<32>{#p/story}* Stardrake和Jerry\n  不会为此产生任何情绪！']
                        : ['<32>{#p/story}* Stardrake泰然自若。\n* Jerry。']
    },
    ...
    b_opponent_stardrake: {
        ...
        act_check2: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* CHILLDRAKE - 攻击12 防御7\n* 看啥都要对着干！！\n* 他在找逃跑路线。']
                : ["<32>{#p/story}* STARDRAKE - 攻击12 防御7\n* 想跟你打趣，\n  但被打得没趣了。"],
        act_check3: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* CHILLDRAKE - 攻击12 防御7\n* 看啥都要对着干！！\n* 尤其是调情！！']
        ...
        heckleText1: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/human}* (你谴责Chilldrake的行为。）']
                : ['<32>{#p/human}* （你对Stardrake喝倒彩。）'],
        heckleText2: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/human}* （你鼓励Chilldrake\n  去其他地方当反叛者。）']
                : ["<32>{#p/human}* （你说Stardrake\n  没有一点幽默细胞。）"],
        heckleText3: () =>
            SAVE.data.b.s_state_chilldrake
                ? [
                    '<32>{#p/human}* （你嘲笑Chilldrake\n  在鸟不拉屎的地方抗议。）',
                    '<32>{#p/basic}* Chilldrake将你的嘲讽当做建议，\n  溜达着去镇上了。'
                ]
                : [
        ...
        jokeText0: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/human}* （你认同了Chilldrake。）']
                : ["<32>{#p/human}* （你对Stardrake的言论回以大笑。）"],
        jokeText1: () =>
            SAVE.data.b.s_state_chilldrake
        ...
        jokeText3: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/human}* （你再次认同了Chilldrake。）']
                : ["<32>{#p/human}* （你继续对Stardrake\n  的双关回以大笑。）"],
        ...
        randStatus1: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* Chilldrake想知道Starry的去向。']
                : ['<32>{#p/story}* Stardrake正在审视人群。'],
        randStatus2: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* Chilldrake正在吟唱\n  无政府主义的咒语。']
                : ['<32>{#p/story}* Stardrake正在练习下一个双关。'],
        randStatus3: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* Chilldrake着手着一场\n  怪物暴动。']
                : ['<32>{#p/story}* Stardrake被自己想出的\n  下一个双关笑话逗笑了。'],
        randStatus4: () => ['<32>{#p/story}* 闻起来像湿枕头。'],
        randStatus5: () =>
            SAVE.data.b.s_state_chilldrake
                ? ['<32>{#p/story}* 身体喷雾的味道扑面而来。']
                : ['<32>{#p/story}* Stardrake因自己的名字\n  不是双关语而松了一口气。'],
        status1: () =>
            SAVE.data.b.s_state_chilldrake
    ...
    b_opponent_jerry: {
        ...
        act_flirt: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/human}* （你向Jerry调情。）\n* （它感谢你的赞美。）']
                : 5 <= world.flirt
                    ? ['<32>{#p/human}* （你调用你的经验，\n  发出一场改变人生的调情。）']
                    : [
                        '<32>{#p/human}* （你向Jerry调情。）',
                        '<32>{#p/basic}* Jerry有点喜欢你了...\n  好像过头了。'
                    ],
        act_ditch: () => ['<32>{#p/human}* （你甩掉了Jerry。）'],
        act_kiss: () => ['<32>{#p/human}* （你亲吻了Jerry。）'],
        flirtStatus: ["<32>{#p/story}* Jerry的救赎之旅开始了。"],
        ...
        randStatus1: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* Jerry的生活无忧无虑。']
                : ['<32>{#p/story}* Jerry吃着粉状的食物，\n  自豪地舔着手。'],
        randStatus2: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* Jerry咯咯地笑着。']
                : ['<32>{#p/story}* Jerry打喷嚏时\n  的粘液飞的到处都是。'],
        randStatus3: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* Jerry发出一声兴奋的尖叫。']
                : ['<32>{#p/story}* Jerry打了个哈欠。'],
        randStatus4: () =>
            SAVE.data.b.spared_jerry
                ? ['<32>{#p/story}* 闻起来像... Jerry？']
                : ['<32>{#p/story}* 闻起来像... Jerry。'],
        status1: ['<32>{#p/story}* Jerry缠上你了！'],
    ...
    b_opponent_mouse: {
        ...
        act_direct3: ["<32>{#p/human}* （你尝试告诉Whizkarat更多，\n  但它已经找到了适合\n  自己的生活方式。）"],
        act_disown: [
        ...
        name: '* Whizkarat',
        randStatus1: ['<32>{#p/story}* Whizkarat幻想着四肢着地。'],
        randStatus2: ['<32>{#p/story}* Whizkarat正在扫描这个区域。'],
        ...
        safeStatus: () =>
            world.goatbro ? ["<32>{#p/asriel2}* 不堪一击。"] : ['<32>{#p/story}* Whizkarat前程无量。'],
    ...
    b_opponent_doggo: {
        ...
        name: '* Doggo',
        fetchStatus: ['<32>{#p/story}* Doggo喜欢玩抛接游戏！'],
    ...
    b_opponent_lesserdog: {
        act_check: () =>
            world.goatbro
                ...
                : ['<32>{#p/story}* CANIS MINOR - 攻击12 防御2\n* 手持一把闪亮的狗狗长剑，\n  剑身由“砹锌合金”锻造而成。'],
        act_check2: [
            '<32>{#p/story}* CANIS MINOR - 攻击12 防御2\n* 这只小狗一生都伤痕累累，\n  想要转身逃跑。'
        ],
        act_check3: [
        ...
        act_check4: ['<32>{#p/story}* CANIS MINOR - 攻击12 防御2\n* 为破译你发出的\n  爱的密码而付出全力。'],
        act_check5: ['<32>{#p/story}* CANIS MINOR - 攻击12 防御2\n* 这只小狗的旅程才刚刚开始。'],
        ...
        fetchStatus: ['<32>{#p/story}* Canis Minor喜欢玩抛接游戏！'],
    ...
    b_opponent_dogaressa: {
        act_check: () =>
            world.goatbro
                ...
                : ['<32>{#p/story}* DOGARESSA - 攻击14 防御5\n* 这只小狗认为她丈夫很可爱。\n  仅限于气味的那种？'],
        act_check2: ['<32>{#p/story}* DOGARESSA -  攻击14 防御5\n* 这只小狗非常想念她的老公\n  仅限于被杀掉后的那种？'],
        act_check3: ['<32>{#p/story}* DOGARESSA - 攻击14 防御5\n* 对这只小狗来说\n  事态进展得很顺利。'],
        act_check4: [
            "<32>{#p/story}* DOGARESSA - 攻击14 防御5\n* 这只小狗发觉可爱的东西\n  不只有她老公。"
        ],
        act_check5: ["<32>{#p/story}* DOGAMY - 攻击14 防御5\n* 这只小狗在为她老公的安危担忧。"],
    ...
    b_opponent_greatdog: {
        act_check: () =>
            world.goatbro
                ...
                : ["<32>{#p/story}* CANIS MAJOR - 攻击15 防御8\n* 太过兴奋，以至于将\n  战斗当作儿戏。"],
        act_check2: ['<32>{#p/story}* CANIS MAJOR - 攻击15 防御8\n* 渴望着关爱与照顾...'],
        act_check3: ['<32>{#p/story}* CANIS MAJOR - 攻击15 防御8\n* 已经累到虚脱了。'],
        act_flirt: [
        ...
        name: '* Canis Major',
        fetchStatus: ['<32>{#p/story}* Canis Major喜欢玩抛接游戏！'],
        petStatus1: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Canis Major。']
    ...
    b_opponent_papyrus: {
        ...
        flirtStatus8: ['<32>{#p/story}* Papyrus往他耳后抹了点\n  MTT牌可爱汁。'],
        ...
        spaghetti2: ["<32>{#p/basic}* 要不是Papyrus现在忙于战斗，\n  他大概就注意到了。"],
    ...
    i_fryz: {
        ...
        drop: ["<32>{#p/human}* （你把烈焰Grillby当做燃烧瓶\n  抛了出去。）"],
        info: () =>
            SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
                ? ['<32>{#p/human}* （30 HP。）']
                : ['<32>{#p/basic}* “烈焰Grillby” 回复30 HP\n* 这次可不只是“暖暖的”了哦。'],
        name: "烈焰Grillby",
        use: ["<32>{#p/human}* （你喝掉了烈焰Grillby。）"]
    },
    i_burgerz: {
        battle: {
                ...
                SAVE.data.n.plot === 72
                    ...
                    : 65 <= SAVE.data.n.plot
                        ? SAVE.data.b.a_state_hapstablook
                            ? 68 <= SAVE.data.n.plot
                                ? [
                                    '<32>{#p/napstablook}{#k/3}* 嘿，mettaton刚刚来过',
                                    "<32>{#k/0}* 我们聊了一些以前的家常...",
                            ...
                            : 60 <= SAVE.data.n.plot
                                ? SAVE.data.b.a_state_napstadecline
                                    ...
                                    : [
                                        '<32>{#k/1}* 哦... 对...',
                                        '<32>{#k/3}* 谢谢你同意\n  帮助我去做那件事',
                                        "<32>{#k/2}* mettaton最近的行为有点奇怪...",
                                        "<32>{#k/0}* 但他这么做\n  我一点都不惊讶",
                                        '<32>{#k/4}* alphys前阵子第一次带我看\n  喵喵太空探险系列的电影...',
        ...
        s_town1: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        "<25>{#p/undyne}{#f/14}* ...他喜欢Grillby's的\n  美味新品！",
                        '<18>{#p/papyrus}{#f/4}什么？\n美味新品？',
        ...
        s_backrooms: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ? []
                    : [
                        "<25>{#p/undyne}{#f/1}* 这不是Canis Minor\n  平时喜欢待的地方吗？",
        ...
        f_sans: pager.create(
            ...
            () =>
                solo()
                    ...
                    : [
                        "<18>{#p/papyrus}{#f/5}就连UNDYNE都被SANS的\n坏习惯影响了...",
            ...
            () =>
                solo()
                    ...
                    : [
                        ...
                        "<18>{#p/papyrus}{#f/0}UNDYNE其实不是真的想\n偷你的东西的。",
        ...
        f_story1: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ? []
                    : [
                        "<25>{#p/undyne}{#f/12}* 所以我想传给Alphys信息的\n  计划才失败了的。",
                        '<18>{#p/papyrus}{#f/6}你用讯星给ALPHYS传过\n信！？',
                        '<18>{#p/papyrus}{#f/5}噢...\nUNDYNE...',
                        "<25>{#p/undyne}{#f/17}* 怎么？\n* 我就还以为它知道要给谁\n  说呢！",
        ...
        f_path: pager.create(
            ...
            () => [
                ...
                ...(solo()
                    ? []
                    : [
                        '<25>{#p/undyne}{#f/12}* 可能这就是Alphys总说的\n  “空间扭曲”现象吧。',
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        "<25>{#p/undyne}{#f/10}* 无论是Cozmo对美学本质\n  的争执...",
                        '<25>{#p/undyne}{#f/10}* 又或是Terrestria对\n  “宇宙之美”的痴迷...',
            ...
            () => [
                ...
                ...(solo()
                    ...
                    : [
                        ...
                        '<18>{#p/papyrus}{#f/6}但是，\n谁都有不如意的时候嘛。',
                        '<25>{#p/undyne}{#f/14}* 你这个“谁”包括Papyrus吗？',
                    ...
                    ? [
                        ...
                        ...(solo()
                            ...
                            : [
                                ...
                                "<25>{#p/undyne}{#f/17}* 你应该提醒我的，Papyrus！！\n* 我现在没退路了！",
        ...
        a_path4: pager.create(
            ...
            () =>
                solo()
                    ...
                    : [
                        '<18>{#p/papyrus}{#f/0}所以BRATTY和CATTY\n是垃圾贩子对吧？',
        ...
        a_mettaton2: pager.create(
            ...
            () => [
                ...
                ...(SAVE.data.n.plot < 60
                    ...
                    : [
                        '<18>{#p/papyrus}{#f/4}METTATON想让我上，可...',
