                ...
                SAVE.storage.inventory.contents.includes('tvm_mewmew') // NO-TRANSLATE
                    ...
                    : 65 <= SAVE.data.n.plot
                        ...
                        : 63 <= SAVE.data.n.plot && SAVE.data.b.a_state_hapstablook
                            ...
                            : 60 <= SAVE.data.n.plot
                                ? [
                                    "<32>{#p/napstablook}* 我有個夢想就是成為鎂塔頓節目\n  中的一名嘉賓，今天它成真了...",
                                    "<32>* 我不知道還有沒有機會\n  可以讓我再去參加一次"
                                ]
                                : 49 <= SAVE.data.n.plot
                                    ? [
...
'<25>{#p/asgore}{#f/15}* 那... 你-你倆旁邊的小孩\n  又是怎麼回事？',
        ...
        npcinter: {
                                    ...
                                    : SAVE.data.n.state_foundry_undyne === 2
                                        ...
                                        : 2 <= SAVE.data.n.plot_date
                                            ...
                                            : SAVE.data.n.plot > 47.2 && SAVE.data.n.plot_date > 1
                                                ? world.trueKills > 0
                                                    ? ['<32>{#p/basic}{#npc/a}* 帕派瑞斯在附近等著呢。', "<32>* 他是不是很勇敢？"]
            ...
            f_longsy: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ? [
                            "<32>{#p/basic}{#npc/a}* 我和我朋友小不點\n  計畫成為新世界的\n  頂級建築師。",
                            "<32>* 我們將建造橋梁、高塔、\n  空間站... 只有你想不到的，\n  沒有我們建不了的！",
                            "<32>* 像往常一樣，\n  我負責搬運工具。"
                        ]
                        : SAVE.data.n.plot < 48
                            ? [
                                '<32>{#p/basic}{#npc/a}* 我和我的朋友小不點\n  打算建一座橋。',
                                "<32>* 他倒是有自己的想法。\n* 但就我而言，我只是不想再用\n  那個不穩定的木筏了。",
                                "<32>* 希望我們能做得\n  比之前更好吧。"
                            ]
                            : [
        ...
        sansSentry: () =>
            SAVE.data.b.svr
                ...
                : world.darker
                    ? ["<32>{#p/basic}* 一個哨站。"]
                    : ["<32>{#p/basic}* 衫斯的第二個哨站...", "<32>* 好像一個還不夠。"],
        sansSentryBack: () =>
        ...
        spookydate1: pager.create(
            ...
            () => ["<25>{#p/sans}* 我的話仍然作數。\n* 去烤爾比嗎？", choicer.create('* （你要怎麼回答？）', '走吧', '不了')]
        ),
...
'<25>{#f/0}* 你肯定會嚇到的。',
        ...
        trivia: {
            ...
            ghostparty3: pager.create(
                0,
                [
                    "<32>{#p/mettaton}{#e/mettaton/9}* 當小幽在店裡忙的時候，\n  我們決定再一次照看它的農場。",
                    "<32>{#e/mettaton/8}* 當然，\n  只在離開前哨站的前一天。",
                    "<32>{#e/mettaton/36}* 回想起來，\n  我對整件事表現得\n  有點過於戲劇化了。",
                    "<32>{#e/mettaton/36}* 小幽【什麼】都沒做錯...\n  我只是不想承認\n  我為此厭倦罷了。",
...
'<32>{#p/human}* （好心痛。）',
    ...
    b_opponent_woshua: {
        ...
        act_check: () =>
            world.goatbro
                ...
                : [
                    '<32>{#p/story}* 刷潔頓 - 攻擊18 防禦5\n* 這個卑微的細菌恐懼症患者\n  想要清理整個星系。'
                ],
        act_check2: [
            '<33>{#p/story}* 刷潔頓 - 攻擊18 防禦5\n* 這個卑微的細菌恐懼症患者\n  想要回家清洗傷口。'
        ],
        act_check3: [
            '<32>{#p/story}* 刷潔頓 - 攻擊18 防禦5\n* 距離當上未來的潔淨怪物\n  只有一爪之遙。'
        ],
    ...
    b_opponent_moldbygg: {
        ...
        act_check: () =>
            world.goatbro
                ...
                : ['<32>{#p/story}* 大黏簇 - 攻擊18 防禦18\n* 它已經從「小糰子」進化成功。'],
        act_check2: ['<32>{#p/story}* 大黏簇 - 攻擊18 防禦18\n* 狀態並不是很好。'],
        act_check3: ['<32>{#p/story}* 大黏簇 - 攻擊18 防禦18\n* 允許成為全職果凍墊。'],
        act_check4: ['<32>{#p/story}* 大黏簇 - 攻擊18 防禦18\n* 和你的關係並沒有想像的那麼好...'],
    ...
    b_opponent_moldfake: {
        ...
        fakeStatus1: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 小黏團。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                    ? ['<32>{#p/kidding}* 小黏團總是這樣靜止不動嗎？']
                    : ["<32>{#p/story}* 小黏團靜止不動。"],
        fakeStatus2: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 小黏團。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                    ? ["<32>{#p/kidding}* 小黏團有點不對勁..."]
                    : ['<32>{#p/story}* 小黏團是一種完全經過回火的\n  明膠，沒有任何瑕疵。'],
        fakeStatus3: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 小黏團。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                    ? ['<32>{#p/kidding}* 小黏團總是這麼安靜嗎？']
                    : ["<32>{#p/story}* 現在是小黏團的安靜時間。"],
        fakeStatus4: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 小黏團。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
    ...
    b_opponent_shyren: {
        ...
        act_check6: ['<32>{#p/story}* 害羞塞壬 - 攻擊19 防禦0\n* 唉，被拒絕的苦澀滋味。'],
        act_check7: ['<32>{#p/story}* 害羞塞壬 - 攻擊19 防禦0\n* 怦然心跳，歌星閃耀！'],
        ...
        encourage4: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* 害羞塞壬正在暢想未來。']
                : ['<32>{#p/kidding}* 再來一遍！\n* 再來一遍！\n* 再來一遍！'],
        flirtText1: ['<32>{#p/human}* （你向害羞塞壬調情。）\n* （雖然感到忐忑，\n  但作為回應，她臉紅了一下。）'],
        ...
        humX4: () => [
            "<32>{#p/human}* （你和害羞塞壬經歷了這麼多，\n  但是時候了。）",
            '<32>* （你們都還有自己的旅程。）',
            '<32>* （你哼了一段告別曲。）'
        ],
        hurtStatus: ["<32>{#p/story}* 害羞塞壬的嗓音變得沙啞。"],
        name: '* 害羞塞壬',
        randStatus1: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* 害羞塞壬虛弱地哼著。']
                : ['<32>{#p/kidding}* 你還好嗎？'],
        randStatus2: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* 害羞塞壬假裝自己是一個超級偶像。']
                : ['<32>{#p/kidding}* 你好像很難過...'],
        randStatus3: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* 害羞塞壬用她的鰭輕拍了一下。']
        ...
        act_boo2: [
            ...
            '<32>{#p/basic}* 害羞塞壬看到你這麼應對拒絕，\n  氣衝衝地離開了。'
        ],
        act_boo3: [
            '<32>{#p/human}* （你朝著害羞塞壬喝倒彩。）',
            "<32>{#p/basic}* 害羞塞壬短暫的快樂轉瞬即逝。"
        ],
        act_boo4: [
            '<32>{#p/human}* （你朝著害羞塞壬喝倒彩。）',
            '<32>{#p/basic}* 觀眾看著害羞塞壬逃離了現場，\n  頓時亂作一團。'
        ],
        act_boo5: [
            '<32>{#p/human}* （你朝著害羞塞壬喝倒彩。）',
            '<32>{#p/basic}* 突如其來的背叛使害羞塞壬崩潰，\n  她大哭地逃離了現場。'
        ]
    },
    b_opponent_radtile: {
        epiphany: [
        ...
        act_check: () =>
            world.goatbro
                ...
                : ['<32>{#p/story}* 老頑鱷 - 攻擊24 防禦12\n* 戴著星河般墨鏡的觀星者。\n* 最喜歡的樂曲類別：克氏量子樂。'],
        act_check2: ["<32>{#p/story}* 老頑鱷 - 攻擊24 防禦12\n* 對這隻酷鱷魚來說，\n  事情發展的不太樂觀。"],
        act_check3: ['<33>{#p/story}* 老頑鱷 - 攻擊24 防禦12 \n* 這條酷鱷魚正熱血沸騰。'],
        act_check4: [
            '<32>{#p/story}* 老頑鱷 - 攻擊24 防禦12\n* 說起浪漫，這條酷鱷魚\n  非常的冷酷無情。'
        ],
        name: '* 老頑鱷',
        ...
        randStatus1: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ...
                : ['<32>{#p/story}* 老頑鱷正在調整他的帽子。'],
        randStatus2: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ["<32>{#p/kidding}* 這裡每個人都喜歡頑頑的小鏡子。"]
                : ['<32>{#p/story}* 老頑鱷深深地看著鏡子裡的自己。'],
        randStatus3: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ["<32>{#p/kidding}* 他到底在幹啥？"]
                : ['<32>{#p/story}* 老頑鱷正在做手勢\n  用來顯得自己更酷。'],
        ...
        act_praise: ["<32>{#p/human}* （你告訴老頑鱷\n  他和量子黃瓜一樣酷。）"],
        act_praise_bullied: ['<32>{#p/human}* （你告訴老頑鱷他的傷疤\n  讓他看起來更剛毅。）'],
        ...
        act_insult_bullied: ["<32>{#p/human}* （你嘲笑老頑鱷的傷痕，\n  讓他滾開。）"],
        act_flirt: ['<32>{#p/human}* （你引誘老頑鱷。）'],
        act_flirt_bullied: ["<32>{#p/human}* （你告訴老頑鱷，\n  就算他被毀容，也依然很漂亮。）"],
    ...
    b_opponent_doge: {
                ...
                : battler.volatile[0].vars.pet
                    ...
                    : battler.volatile[0].sparable
                        ...
                        : world.flirt < 10
                            ...
                            : ['<32>{#p/human}* （你向督吉調情。）', '<32>{#p/basic}* 督吉正在竭力抵抗你。'])
        ],
        act_flirt2: [
            '<32>{#p/human}* （你再次對督吉調情。）',
            "<32>{#p/basic}* 督吉快撐不住了..."
        ...
        batheTextEarly: ["<32>{#p/human}* （你讓督吉去衝個澡，\n  但她現在並不怎麼想去。）"],
        batheTextGeno: [
            '<32>{#p/human}* （你讓督吉去衝個澡。）',
    ...
    b_opponent_undyne: {
        ...
        turnTalkB3: () =>
            SAVE.data.n.state_starton_papyrus === 1
                ...
                : respecc()
                    ? ['<20>{#p/undyne}{#e/undyne/4}就像艾菲斯給我\n看的動漫一樣...']
...
'<20>...才怪。',
    ...
    b_opponent_dateundyne: {
        ...
        flirtStatus2: ['<32>{#p/story}* 安黛因頂不住了。'],
        flirtText0: ['<32>{#p/human}* （你向安黛因調情。）'],
        flirtText1: ["<32>{#p/human}* （你告訴安黛因，\n  她已經得到了你的心。）"],
        flirtText2: ["<32>{#p/human}* （你讚美了安黛因\n  那勇敢的戰鬥精神。）\n* （她現在是你的英雄。）"],
        flirtText3: ["<32>{#p/human}* （你告訴安黛因\n  她是一個可愛淘氣的小寶貝。）"],
    ...
    n_shop_tem: {
        ...
        talk: () => [
            ...
            SAVE.data.n.plot === 72 ? '未來發展' : SAVE.data.b.colleg ? '提米盔甲' : '來個自我介紹',
