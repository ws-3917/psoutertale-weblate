...
export default {
    a_foundry: {
        ...
        blookdate8: ['<32>{#p/napstablook}* well, that was nice...', '<32>* gracias...'],
        blookdate8x: ['<32>{#p/napstablook}* bueno, eso fue rapido......', '<32>* thanks for trying, though......'],
        ...
        blookmusic1: () => [
            ...
            choicer.create('* (Play a song?)', 'Spooktune', 'Spookwave', 'Spookwaltz', 'Cancelar')
        ],
        ...
        blooksnail2b0: ['<32>{#p/napstablook}* esta bien...........'],
        ...
        blooksnail4a: [
            '<32>{#p/napstablook}* ganaste... felicitaciones.',
        ...
        blooksnail4b: [
            ...
            '<32>* oh no... el caracol se pondrá triste...',
        ...
        blooktouch1: () =>
            world.sad_ghost
                ? [
                    ...
                    choicer.create('* (What do you say?)', 'Perdón', 'Nada')
                ]
                : [
                    '<32>{#p/napstablook}* oh, do you need anything?',
                    choicer.create('* (What do you say?)', 'Abrazar', 'Dormir', 'Música', 'Nada')
                ],
        blooktouch2a1: [
        ...
        blooktouch2c4: () => [
            ...
            choicer.create('* (What do you say?)', 'Bueno', 'Malo')
        ],
        blooktouch2c5a: [
                ...
                SAVE.storage.inventory.contents.includes('tvm_mewmew') // NO-TRANSLATE
                    ...
                    : 65 <= SAVE.data.n.plot
                        ...
                        : 63 <= SAVE.data.n.plot && SAVE.data.b.a_state_hapstablook
                            ? ['<32>* oh...\n* oye......', '<32>* i just came back here to keep an eye on the snails......']
                            : 60 <= SAVE.data.n.plot
                                ? [
                                ...
                                : 49 <= SAVE.data.n.plot
                                    ...
                                    : [
                                        ...
                                        ...(world.killed0
                                            ? [
                                                "<32>* oye, eso es extraño...",
                                                '<32>* mis caracoles desaparecieron...',
            ...
            postSIGMA()
                ...
                : SAVE.data.b.svr
                    ? [
                        ...
                        choicer.create('* (What will you make?)', 'Licorice', 'Chisps', 'Rations', 'Nada')
                    ]
                    : [
        ...
        npc86b: () => [
            ...
            choicer.create('* (What do you say?)', 'Rojo', 'Verde', 'Azul', 'Not sure')
        ],
        npc86c: [
        ...
        npc86d: () => [
            ...
            choicer.create('* (What do you say?)', 'Bueno', 'Malo', 'Neutral', 'Not sure')
        ],
        npc86e: () => [
            ...[
        ...
        npc86f: () => [
            ...
            choicer.create('* (What do you say?)', 'Amor', 'Disgusto', 'Ninguno', 'Not sure')
        ],
        npc86g: () =>
            [
                [
        ...
        spookydate1: pager.create(
            ...
            () => [
                ...
                choicer.create('* (What do you say?)', 'Claro', 'No')
            ],
            () => ["<25>{#p/sans}* my offer remains.\n* grillby's?", choicer.create('* (What do you say?)', 'Claro', 'No')]
        ),
        ...
        spookydate13: () => [
            ...
            choicer.create('* (What do you say?)', 'Fácil', 'Difícil')
        ],
        spookydate14a: [
            '<25>{#p/sans}* easy?\n* get outta here.',
        ...
        unddate13: () => [
            ...
            choicer.create('* (What do you say?)', 'Hungry', 'Libro', 'Hogar', 'Nada')
        ],
        unddate13a1: [
        ...
        unddate38: () => [
            ...
            choicer.create('* (What will you do?)', 'Mascota', 'Pound')
        ],
        unddate39a: () => [
    ...
    b_opponent_radtile: {
        ...
        insultIdleTalk2: ['<08>{#p/basic}{~}Como sea.'],
    ...
    b_opponent_undyne: {
                ...
                ? SAVE.data.n.hp < 6
                    ...
                    : SAVE.data.n.hp < 11
                        ...
                        : SAVE.data.n.hp < 16
                            ...
                            : [
                                '<20>{#p/undyne}{#e/undyne/4}Impresionante...',
        ...
        genoCutscene2: ['<08>{#p/kidding}{#e/kidd/3}¡¡¡UNDYNE!!!', '<08>{#e/kidd/4}¡YO...!'],
        genoCutscene3: ['<20>{#p/undyne}{#e/undyne/1}¿Niño...?'],
        genoCutscene3x: [
        ...
        genoCutscene6: ['<08>{#p/kidding}{#e/kidd/6}Yo...', '<08>{#p/kidding}{#e/kidd/6}Yo...'],
        ...
        genoCutscene12e: ['<20>Yo...', "{#e/undyne/8}I can't..."],
    ...
    n_shop_tem: {
        ...
        itemPurchasePrompt: (free: boolean) => (free ? 'Buy it for FREE?' : temgone() ? 'Take it?' : 'Buy it for\n$(x)G?'),
