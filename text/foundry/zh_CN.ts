                ...
                SAVE.storage.inventory.contents.includes('tvm_mewmew') // NO-TRANSLATE
                    ...
                    : 65 <= SAVE.data.n.plot
                        ...
                        : 63 <= SAVE.data.n.plot && SAVE.data.b.a_state_hapstablook
                            ...
                            : 60 <= SAVE.data.n.plot
                                ? [
                                    "<32>{#p/napstablook}* 我有个梦想就是成为mettaton节目\n  中的一名嘉宾，今天它成真了...",
                                    "<32>* 我不知道还有没有机会\n  可以让我再去参加一次"
                                ]
                                : 49 <= SAVE.data.n.plot
                                    ? [
...
'<25>{#p/asgore}{#f/15}* 那... 你-你俩旁边的小孩\n  又是怎么回事？',
                                    ...
                                    : SAVE.data.n.state_foundry_undyne === 2
                                        ...
                                        : 2 <= SAVE.data.n.plot_date
                                            ...
                                            : SAVE.data.n.plot > 47.2 && SAVE.data.n.plot_date > 1
                                                ? world.trueKills > 0
                                                    ? ['<32>{#p/basic}{#npc/a}* Papyrus在附近等着呢。', "<32>* 他是不是很勇敢？"]
        ...
        sansSentry: () =>
            SAVE.data.b.svr
                ...
                : world.darker
                    ? ["<32>{#p/basic}* 一个哨站。"]
                    : ["<32>{#p/basic}* Sans的第二个哨站...", "<32>* 好像一个还不够。"],
        sansSentryBack: () =>
        ...
        spookydate1: pager.create(
            ...
            () => ["<25>{#p/sans}* 我的话仍然作数。\n* 去grillby's吗？", choicer.create('* （你要怎么回答？）', '走吧', '不了')]
        ),
                ...
                : [
                    ...
                    ...(SAVE.data.n.state_foundry_undyne > 0
                        ...
                        : [
                            '<18>{#f/4}你准备好接受这个...',
                            '<18>{#f/1}和皇家卫队队长\n做朋友的艰巨的\n任务了吗！？！？',
                            choicer.create('* （和Undyne做朋友吗？）', '好啊', '不要')
                        ])
                ],
        unddate0x: () =>
            world.trueKills > 0 || SAVE.data.n.state_foundry_undyne > 0
...
'<32>{#p/human}* （好心痛。）',
    ...
    b_opponent_moldbygg: {
        ...
        act_check2: ['<32>{#p/story}* GELATA - 攻击18 防御18\n* 状态并不是很好。'],
        act_check3: ['<32>{#p/story}* GELATA - 攻击18 防御18\n* 允许成为全职果冻垫。'],
        act_check4: ['<32>{#p/story}* GELATA - 攻击18 防御18\n* 和你的关系并没有想象的那么好...'],
    ...
    b_opponent_moldfake: {
        ...
        fakeStatus1: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Gelatini。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                    ? ['<32>{#p/kidding}* Gelatini总是这样静止不动吗？']
                    : ["<32>{#p/story}* Gelatini静止不动。"],
        fakeStatus2: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Gelatini。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                    ? ["<32>{#p/kidding}* Gelatini有点不对劲..."]
                    : ['<32>{#p/story}* Gelatini是一种完全经过回火的\n  明胶，没有任何瑕疵。'],
        fakeStatus3: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Gelatini。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                    ? ['<32>{#p/kidding}* Gelatini总是这么安静吗？']
                    : ["<32>{#p/story}* 现在是Gelatini的安静时间。"],
        fakeStatus4: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* Gelatini。']
                : world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
    ...
    b_opponent_shyren: {
        ...
        act_check6: ['<32>{#p/story}* SHYREN - 攻击19 防御0\n* 唉，被拒绝的苦涩滋味。'],
        act_check7: ['<32>{#p/story}* SHYREN - 攻击19 防御0\n* 怦然心跳，歌星闪耀！'],
        ...
        encourage4: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* Shyren正在畅想未来。']
                : ['<32>{#p/kidding}* 再来一遍！\n* 再来一遍！\n* 再来一遍！'],
        flirtText1: ['<32>{#p/human}* （你向Shyren调情。）\n* （虽然感到忐忑，\n  但作为回应，她脸红了一下。）'],
        ...
        hurtStatus: ["<32>{#p/story}* Shyren的嗓音变得沙哑。"],
        name: '* Shyren',
        randStatus1: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* Shyren虚弱地哼着。']
                : ['<32>{#p/kidding}* 你还好吗？'],
        randStatus2: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* Shyren假装自己是一个超级偶像。']
                : ['<32>{#p/kidding}* 你好像很难过...'],
        randStatus3: () =>
            SAVE.data.n.state_foundry_muffet === 1
                ? ['<32>{#p/story}* Shyren用她的鳍轻拍了一下。']
    ...
    b_opponent_radtile: {
        ...
        act_check2: ["<32>{#p/story}* RADTILE - 攻击24 防御12\n* 对这只酷鳄鱼来说，\n  事情发展的不太乐观。"],
        act_check3: ['<33>{#p/story}* RADTILE - 攻击24 防御12 \n* 这条酷鳄鱼正热血沸腾。'],
        act_check4: [
            '<32>{#p/story}* RADTILE - 攻击24 防御12\n* 说起浪漫，这条酷鳄鱼\n  非常的冷酷无情。'
        ],
        name: '* Radtile',
        ...
        randStatus1: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ...
                : ['<32>{#p/story}* Radtile正在调整他的帽子。'],
        randStatus2: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ["<32>{#p/kidding}* 这里每个人都喜欢Raddy的小镜子。"]
                : ['<32>{#p/story}* Radtile深深地看着镜子里的自己。'],
        randStatus3: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ["<32>{#p/kidding}* 他到底在干啥？"]
        ...
        act_praise: ["<32>{#p/human}* （你告诉Radtile\n  他和量子黄瓜一样酷。）"],
        act_praise_bullied: ['<32>{#p/human}* （你告诉Radtile他的伤疤\n  让他看起来更刚毅。）'],
        ...
        complimentStatus: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ...
                : ['<32>{#p/story}* Radtile想让你先“查看”他。'],
        checkTalk: ['<08>{#p/basic}{~}我咋\n这么帅呢，\n嘿嘿。'],
        realTalk1: ['<08>{#p/basic}{~}对咯。'],
        realStatus: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ['<32>{#p/kidding}* 你做到了！\n* ...我们能走了吗？']
                : ["<32>{#p/story}* Radtile感觉比以前酷多了。"],
        ...
        shockStatus: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ['<32>{#p/kidding}* 呃...']
                : ['<32>{#p/story}* Radtile不咋开心。'],
        act_insult: ['<32>{#p/human}* （你大骂Radtile废物，\n  让他闭上臭嘴。）'],
        act_insult_bullied: ["<32>{#p/human}* （你嘲笑Radtile的伤痕，\n  让他滚开。）"],
        act_flirt: ['<32>{#p/human}* （你引诱Radtile。）'],
        act_flirt_bullied: ["<32>{#p/human}* （你告诉Radtile，\n  就算他被毁容，也依然很漂亮。）"],
        insultTalk1: ["<08>{#p/basic}{~}如果我不\n呢？"],
        insultStatus: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ['<32>{#p/kidding}* 呃...']
                : ['<32>{#p/story}* Radtile保持着距离。'],
        checkPostInsultTalk: ['<08>{#p/basic}{~}来再\n看一下\n不？\n'],
        checkPostInsultStatus: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
                ? ["<32>{#p/kidding}* 啊，我们在兜圈子！"]
                : ['<32>{#p/story}* Radtile给你一个机会。'],
        hurtStatus: () =>
            world.kiddo && SAVE.data.n.state_foundry_muffet !== 1
    ...
    b_opponent_doge: {
                ...
                : battler.volatile[0].vars.pet
                    ...
                    : battler.volatile[0].sparable
                        ...
                        : world.flirt < 10
                            ...
                            : ['<32>{#p/human}* （你向Doge调情。）', '<32>{#p/basic}* Doge正在竭力抵抗你。'])
        ],
        act_flirt2: [
            '<32>{#p/human}* （你再次对Doge调情。）',
            "<32>{#p/basic}* Doge快撑不住了..."
        ],
        act_flirt3: [
            '<32>{#p/human}* （你鼓起勇气，\n  叫Doge小可爱。）',
        ...
        batheTextEarly: ["<32>{#p/human}* （你让Doge去冲个澡，\n  但她现在并不怎么想去。）"],
        batheTextGeno: [
            '<32>{#p/human}* （你让Doge去冲个澡。）',
            '<32>{#p/basic}* 但她根本不在乎自己脏不脏。'
        ],
        batheTextLate: ['<32>{#p/human}* （你让Doge去冲个澡，\n  但为时已晚。）'],
...
'<20>...才怪。',
    ...
    b_opponent_dateundyne: {
        ...
        flirtStatus2: ['<32>{#p/story}* Undyne顶不住了。'],
        flirtText0: ['<32>{#p/human}* （你向Undyne调情。）'],
        flirtText1: ["<32>{#p/human}* （你告诉Undyne，\n  她已经得到了你的心。）"],
        flirtText2: ["<32>{#p/human}* （你赞美了Undyne\n  那勇敢的战斗精神。）\n* （她现在是你的英雄。）"],
        flirtText3: ["<32>{#p/human}* （你告诉Undyne\n  她是一个可爱淘气的小宝贝。）"],
