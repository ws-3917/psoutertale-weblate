...
export default {
    _0: {
        _1: 'El jugador hizo todo lo que pudo...',
        _2: 'Pero alas, su destino estaba sellado, y...',
        _3: 'ningún anexo a la historia pudo desenredarlo.',
        _4: 'No había ningún escenario en el que el jugador podría estar realmente satisfecho.',
        _5: 'Es esto lo que ellos enserio merecen?',
        _6: 'El vivir en una agridulce agonía, sabiendo que el nunca pudo ser...',
        _7: 'No...\nNo lo permitiré.',
    ...
    a_common: {
        ...
        lastblook1: [
            ...
            () => [
                ...
                choicer.create('* (Lay down next to it?)', 'Sí', 'No')
            ],
            () => ['<32>{#p/basic}* The ghost is still here.', choicer.create('* (Lay down next to it?)', 'Sí', 'No')]
        ],
        ...
        view: () => [choicer.create('* (Are you ready to go outside?)', 'Sí', 'No')],
        computer1: () =>
            SAVE.data.b.ufokinwotm8
        ...
        computer2: () => [choicer.create('* (Insert the Computer Chip?)', 'Sí', 'No')],
    ...
    b_party_kidd: {
        ...
        mkTurnFight1: () => [
            ...
            choicer.create('* (Do you confirm?)', 'Sí', 'No')
        ],
