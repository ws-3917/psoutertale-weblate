...
'<26>{#p/sans}{#f/0}* 你在前哨站的这段时间，\n  我们搜集到不少\n  有价值的数据。',
                ...
                if (dmettaton) {
                    ...
                    if (!dundyne) {
                        addB([
                            '<32>{#p/napstablook}* 新女王安黛因\n  十分支持我们。',
                            '<32>{#p/napstablook}* ...艾斯戈尔死后，\n  她便继承了王位。',
                            "<32>{#p/napstablook}* 虽然她不怎么喜欢镁塔顿...",
                            '<32>{#p/napstablook}* 但那句“躲不过十五”，\n  让她产生了共鸣。'
                        ]);
                        if (!dtoriel) {
                            addB([
                                '<32>{#p/napstablook}* 呵......\n  那时，托丽尔走出外域，\n  求安黛因放你一马...',
                                '<32>{#p/napstablook}* 结果，被安黛因狠狠笑话一通，\n  赶回了外域。',
'<32>{#p/napstablook}* 回去的路上，安黛因就带领民众，\n  紧跟在后面嘲讽她，\n  一直笑话到她走回外域。',
                        ...
                        addB([
                            '<32>{#p/napstablook}* 可是，王后托丽尔\n  不太支持我们。',
                            '<32>{#p/napstablook}* ...艾斯戈尔死后，\n  她便继承了王位。',
                            "<32>{#p/napstablook}* 她认同镁塔顿的话...",
...
'<32>{#p/mettaton}* 接着，又疏远了她。',
                            '<32>{#p/mettaton}* 虽然艾菲斯还相信你，\n  觉得你有救...\n  但其他民众可不这么想。',
                            '<32>{#p/mettaton}* 出了这些事，\n  他们只想把人类统统杀光。'
                        ]);
                        if (!dtoriel) {
                            addB([
                                "<32>{#p/mettaton}* 过了一阵，托丽尔回归了。\n* 可她根本劝不动\n  这些怪物。",
                                '<32>{#p/mettaton}* 最终，艾菲斯也心灰意冷，\n  放弃了王位。'
                            ]);
                        }
                    } else if (!dundyne) {
                        addB([
...
'<32>{#p/mettaton}* 说实话，出了这些事，\n  换谁谁这么想。',
                    ...
                    addB([
                        ...
                        "<32>{#p/mettaton}* 和你没关系，小幽。",
                        '<32>{#p/napstablook}* 我猜猜......',
                        '<32>{#p/napstablook}* ...\n* 知道了...',
                        '<32>{#p/napstablook}* 嘿...\n* 呃，你伤了我表亲的心',
                        '<32>{#p/napstablook}* 一次巧合，我发现镁塔顿\n  原来是我的表亲...',
'<32>{#p/napstablook}* 艾菲斯逃走了，\n  我就开始照顾他。'
                    ]);
                    ...
                    addB([
                        ...
                        "<32>{#p/mettaton}* 我认识的小幽\n  才不会用这种口气说话，\n  对吧？",
                        "<32>{#p/napstablook}* ......\n* ......我.......",
                        "<36>{#p/mettaton}* 你想让我开心点，我很高兴。\n* 可这事跟你没啥关系，\n  别惹自己不愉快。",
                        '<32>{#p/napstablook}* 镁塔顿...',
                ...
                addB([
                    ...
                    "<25>{#p/sans}{#f/0}* 这还没完，镁塔顿\n  也来蹚这趟浑水，\n  跟着瞎搅和。",
                    "<18>{#p/papyrus}{#f/6}镁塔顿？！\n【他】跟着干啥？",
                    '<25>{#p/sans}{#f/0}* 哦，在艾菲斯当了王，\n  镁塔顿也想“沾点光”。',
                    "<25>{#p/sans}{#f/3}* 但是他...\n  就没提过啥正经建议。",
                ...
                if (!dundyne) {
                    ...
                    if (royals < 6 || mdeaths > 9) {
                        ...
                        if (30 <= SAVE.data.n.bully) {
                            addB(['<25>{#p/alphys}{#f/26}* ...紧接着，安黛因把你\n  揍他们的事拎了出来。',
'<25>{#p/alphys}{#f/26}* 结果...\n  民众立马变卦，纷纷支持她。']);
                        } else {
                            addB([
                                '<25>{#p/alphys}{#f/20}* ...看他们不信，安黛因又说，\n  是你把艾斯戈尔杀了。',
'<25>{#p/alphys}{#f/26}* 结果，\n  民众立马变卦，纷纷支持她。'
                            ]);
                        }
                    }
                    ...
                    if (dtoriel) {
                        ...
                        if (dpapyrus) {
                            ...
                            addB([
                                ...
                                "<25>{#p/alphys}{#f/8}* 帕派瑞斯，给人类讲讲\n  你的新工作吧。",
                                '<18>{#p/papyrus}{#f/0}啊对！！\n我咋把这事忘了呢！？',
                                '<18>{#p/papyrus}{#f/0}终于啊... 安黛因同意\n让我当皇家守卫了。',
...
'<25>{#p/toriel}{#f/13}* 虽然自由了，\n  但心灵都受了创伤。',
                            ...
                            '<25>{#p/alphys}{#f/21}* ...',
                            '<25>{#p/alphys}{#f/21}* 不。\n* 艾菲斯才不想。',
                            '<25>{#p/alphys}{#f/21}* 艾菲斯走了。\n* 再见。',
                            "<25>{#p/alphys}{#f/24}* ...\n* （我就在外面等着，\n  你们聊完，记得叫我。）",
                            '<25>{#p/sans}{#f/0}* ...',
                            '<25>{#p/toriel}{#f/5}* ...'
                        ]);
                        if (SAVE.data.n.state_foundry_undyne === 1) {
                            addB(["<25>{#p/sans}{#f/3}* 安黛因死了，\n  她到现在都没缓过来。"]);
                        } else {
                            addB(["<25>{#p/sans}{#f/3}* 安黛因被你杀了，\n  她都现在都没消气。"]);
                        }
                        if (dmettaton) {
...
'<25>{#p/toriel}{#f/9}* 他们才懒得区分\n  谁是“敌人”，谁是“朋友”。\n* 反正只要是人类，都得死。',
                                '<32>{#p/human}{#v/1}{@fill=#42fcff}* 托丽尔，我好怕...',
...
'<25>{#p/sans}{#f/0}* 上周，一群怪物闯进他的店，\n  把店洗劫一空。',
                        ...
                        addB([
                            ...
                            '<25>{#p/toriel}{#f/1}* ...',
                            '<25>{#p/toriel}{#f/1}* 那天，我遇到了艾菲斯，\n  和她聊了很久。',
                            '<25>{#p/toriel}{#f/1}* 我们从艾斯戈尔说到人类...',
                            '<25>{#p/toriel}{#f/3}* 又从人类聊到\n  什么“喵喵航天行”...',
                            '<25>{#p/toriel}{#f/4}* 我到现在都没搞懂\n  那到底是个啥玩意。',
                            "<25>{#p/toriel}{#f/0}* 总之...\n  她并不想当女王。",
                            '<25>{#p/toriel}{#f/1}* 艾菲斯觉得，\n  我来统治这里更合适。',
                        ...
                        if (hkills === 0) {
                            ...
                            addB(['<25>{#p/toriel}{#f/9}* 电视大明星镁塔顿\n  也死了。']);
                            if (royals < 2) {
                                addB([
                                    '<26>{#p/toriel}{#f/9}* ...而皇家卫队\n  也几乎全军覆没。',
                                    "<25>{#p/toriel}{#f/5}* 对她来说，镁塔顿的死\n  带来的打击尤为强烈。"
                                ]);
                            } else if (royals < 7) {
                                addB([
                            ...
                            addB(["<25>{#p/toriel}{#f/9}* 衫斯的兄弟，帕派瑞斯\n  也死了。"]);
                            if (royals < 2) {
                            ...
                            addB(['<25>{#p/toriel}{#f/9}* 犬卫队成员，遁狗\n  也死了。']);
                        } else if (dlesserdog) {
                            addB(['<25>{#p/toriel}{#f/9}* 犬卫队成员，小犬座\n  也死了。']);
                        } else if (ddogs) {
                            addB(['<25>{#p/toriel}{#f/9}* 犬卫队成员，\n  狗来米和狗媳儿\n  也死了。']);
                        } else if (dgreatdog) {
                            addB(['<25>{#p/toriel}{#f/9}* 犬卫队成员，大犬座\n  也死了。']);
                        } else if (ddoge) {
                            addB(['<25>{#p/toriel}{#f/9}* 特战队成员，督吉\n  也死了。']);
                        } else if (droyalguards) {
                            addB(['<25>{#p/toriel}{#f/9}* 新来的两名守卫，\n  三号和四号\n  也死了。']);
                        } else if (dmadjick) {
                            addB(['<25>{#p/toriel}{#f/9}* 特战队成员，谜宇人\n  也死了。']);
                        } else if (dknightknight) {
                            addB(['<25>{#p/toriel}{#f/9}* 特战队成员，特雷莉亚\n  也死了。']);
                        } else if (mdeaths > 9) {
                        ...
                        addB([
                            ...
                            '<25>{#p/toriel}{#f/10}* 渐渐地，我理解了艾斯戈尔，\n  理解了他当时背负的压力\n  有多重...',
                            '<25>{#p/toriel}{#f/9}* ...我感觉，\n  自己也不知不觉中\n  像变了一个人。',
                            '<25>{#p/toriel}{#f/5}* 就在刚刚...'
                        ]);
                        if (dpapyrus) {
                            addB([
                                '<25>{#p/toriel}{#f/5}* 衫斯找到我，\n  想一起聊聊他的兄弟...',
                    ...
                    addB([
                        '<32>{#p/basic}* 等等！！\n* 我的人类过来了！！',
                        '<32>{#p/human}{#v/3}{@fill=#003cff}* 遁狗长官！\n* 遁狗长官！\n* 快过来快过来，有好看的！',
                        '<32>{#p/basic}* 啥事啊这么急。',
...
'<32>{#p/basic}* 大队长一死，那群废物守卫\n  立马没了凝聚力~\n  一个个自以为是，谁也不服谁~',
                    ...
                    addB([
                        "<32>{#p/basic}{#s/spiderLaugh}* 呦，这不是艾菲斯小亲亲嘛~\n* 今天让你清理水管，\n  怎么还不去呢？",
                        "<32>{#p/basic}* 过了这么久...\n  那里面肯定又脏又臭~",
                        "<32>{#p/basic}* 你不去，谁去呢？"
                    ]);
                    if (royals < 2) {
                        ...
                        addB([
                            ...
                            '<32>{#p/basic}{#s/spiderLaugh}* 不用狡辩啦，艾菲斯小亲亲~\n* 既然这么想被电，\n  那我肯定不会“亏待”你！',
                            '<32>{#p/basic}* 蜘蛛们，把她拖出去！',
                            '<32>{#p/basic}* 我们的艾菲斯想去\n  “极光区”再体验一把\n  高能射线的快感呢~',
                    ...
                    if (dmettaton) {
                        ...
                        if (royals < 2) {
                            ...
                            addB(['<32>{#p/napstablook}* ...', "<32>{#p/napstablook}* 艾菲斯，\n  这是最后的机会！"]);
                        }
                    } else {
                        addB([
                            '<32>{#p/mettaton}* 吹够了没有？',
                        ...
                        if (royals < 2) {
                            ...
                            addB(['<32>{#p/mettaton}* ...', "<32>{#p/mettaton}* 艾菲斯，\n  趁现在，上！"]);
                        }
                    }
                    if (royals < 2) {
                        addB([
                    ...
                    addB([
                        ...
                        "<18>{#p/papyrus}{#f/6}大家都想让艾菲斯\n继承王位...",
                        "<18>{#p/papyrus}{#f/5}可她根本不想当女王。",
                        "<18>{#p/papyrus}{#f/5}大伙又到处找安黛因，\n可就是找不到...",
                        '<18>{#p/papyrus}{#f/4}艾菲斯只能召集\n皇家守卫一起开个会，\n另找合适的人选。'
                    ]);
                    if (royals < 2) {
                        addB([
...
'<18>{#p/papyrus}{#f/6}万一你哪天回来了...\n我一定会让你俩\n重归于好！！',
                ...
                addB([
                    ...
                    "<18>{#p/papyrus}{#f/5}据说，镁塔顿要彻底抛弃\n他的“旧商标”了。",
                    '<18>{#p/papyrus}{#f/4}转而启用“镁塔视界”新商标。',
...
'<32>* 不要再想了。'
            ...
            _frontier10: pager.create(
                ...
                [
                    "<32>{#p/basic}* 艾斯戈尔把他俩的房间\n  弄得这么小，只能说...\n  意料之中。",
                    "<32>* 他可了解怪物的性格了。\n  “甭管是大是小，只要躺着得劲，\n   就是好卧室。”",
                    "<32>* 对怪物来说，简直太对了！"
                ],
                ['<32>{#p/basic}* ...', '<32>* 难怪艾斯利尔昨晚\n  不睡自己的床，\n  跑过来跟你一起睡，'],
                []
            ),
            _void: pager.create(
                0,
        ...
        balcony0: ['<25>{#p/kidd}{#f/3}* 哦，是你呀，弗里斯克...', '<25>{#f/1}* 我还担心你醒不过来呢！'],
        balcony1: () => [
            '<25>{#p/kidd}{#f/3}* ...哈哈。',
            ...(SAVE.data.b.ufokinwotm8
                ? ["<25>{#f/2}* 我做梦都没想到，\n  自己...", '<25>{#f/4}* ...也...']
        ...
        balcony8a: ['<25>{#p/kidd}{#f/4}* 艾斯利尔...？', '<25>{#p/kidd}{#f/4}* 你还好吗？'],
        balcony9a: [
        ...
        balcony24a: ["<33>{#p/basic}* 艾斯利尔，我在这站了这么久，\n  你为啥一直没看见？\n* 我也没跟你玩躲猫猫啊！"],
        balcony25a: ['<26>{#p/asriel1}{#f/23}* ...$(name)，我...'],
        balcony26a1: [
            "<32>{#p/basic}* 没关系的，艾斯利尔。\n* 别自责，别难过。",
            '<32>* 要是想哭... 就哭吧。',
...
'<32>* 懂了吧？'
        ...
        balcony29a: ['<25>{#p/kidd}{#f/14}* ...艾斯利尔是你的兄弟？！', '<25>{#p/kidd}{#f/4}* 信息量太大，有点接受不了...'],
        ...
        balcony34a2: ['<25>{#p/asriel1}{#f/15}* ...你刚刚...', '<33>{#p/basic}* 是的，艾斯利尔。\n  怪物小孩刚刚说的，\n  就是那两句话。'],
        balcony35a1: [
...
'<32>* 说来说去，就是一句话：\n  “放开了玩。”'
            ...
            x_booktable: () =>
                SAVE.data.b.ufokinwotm8
                    ...
                    : [
                        ...
                        '<32>{#p/human}* （日记只写了一篇，\n  你读了读内容...）',
                        '<32>{#p/kidding}* “艾斯戈尔现在成我爹啦！”\n* “总觉得有点怪怪的，\n   但也超级棒！”',
                        '<32>{#p/kidding}* “艾斯戈尔说，我得换一身新衣服，\n   一会我就去换吧。”',
                        '<32>{#p/kidding}* “他还给了我一本日记，\n   让我记录一下生活。”',
                        '<32>{#p/kidding}* “写日记可难不倒我，\n   我认识的字可多了！”',
                        '<32>{#p/kidding}* “要是我那里写了错别字，\n  还有弗里斯克帮我纠正呢！”',
                        '<32>{#p/kidding}* “弗里斯克，看完后\n  别忘了给我圈一下\n  错别字哦。”',
                        '<32>{#p/human}* （你合上了日记。）'
                    ],
            x_bed_left: () => [
                ...(SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
    ...
    b_opponent_spacetop: {
        ...
        act_check: () =>
            world.goatbro
                ...
                : ["<32>{#p/story}* 太空帽 - 攻击11 防御4\n* 这个青年想知道自己为啥不叫\n  “收音劫克”。"],
        act_check2: ['<32>{#p/story}* 太空帽 - 攻击11 防御4\n* 这个青年很欣赏你的时尚感。'],
        act_check3: ['<32>{#p/story}* 太空帽 - 攻击11 防御4\n* 这个青年\n  找到了所有正确的信号。'],
        act_check4: [
            '<32>{#p/story}* 太空帽 - 攻击11 防御4\n* 企图劫持一个收音机\n  来寻求帮助。'
        ],
        act_compliment: ['<32>{#p/human}* （你说太空帽的天线\n  真是太棒了。）'],
        act_flirt: ['<32>{#p/human}* （你向太空帽调情。）'],
        ...
        flirtStatus1: ['<32>{#p/story}* 太空帽不喜欢你的装束。'],
        flirtStatus2: ['<32>{#p/story}* 太空帽坠入爱河。'],
        ...
        randStatus2: ['<32>{#p/story}* 太空帽检查了一下\n  他的天线还在是否那里。'],
    ...
    b_opponent_space: {
        ...
        name: '* 锂块',
        randStatus1: ['<32>{#p/story}* 再也没有“太空帽”了。'],
