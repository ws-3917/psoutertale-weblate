...
export default {
    ...
    a_common: {
                    ...
                    if (royals < 2) {
                        ...
                        if (!dpapyrus) {
                            ...
                            addB([
                                ...
                                '<25>{#p/undyne}{#f/4}* ...\n* Fuhuhuhuhu...',
                                "<25>{*}{#x0}{#p/undyne}{#f/7}* Şimdi yakaladım seni.{^40}{%}"
                            ]);
                        }
                    } else {
        ...
        lastblook1: [
            ...
            () => [
                ...
                choicer.create('* (Lay down next to it?)', 'Evet', 'Hayır')
            ],
            () => ['<32>{#p/basic}* The ghost is still here.', choicer.create('* (Lay down next to it?)', 'Evet', 'Hayır')]
        ],
        ...
        view: () => [choicer.create('* (Are you ready to go outside?)', 'Evet', 'Hayır')],
        computer1: () =>
            SAVE.data.b.ufokinwotm8
        ...
        trivia: {
            ...
            x_chasgore: () => [
                ...
                ...(SAVE.data.b.ufokinwotm8
                    ? []
                    : ['<32>{#p/basic}* Rahat bir okuma koltuğu...', "<32>* Doesn't seem like the right size for Asgore."])
            ],
            x_window_left: () =>
                SAVE.data.b.ufokinwotm8
    ...
    b_group_common: {
        nobody: () => (!world.genocide && world.bullied ? '* ... ama herkes kaçtı.' : '* ... ama kimse gelmedi.')
    },

    b_opponent_dummy: {
        act_check: ["<32>{#p/story}* MANKEN - SAL 0 SAV 0\n* Kabuğunda bir hayalet, diler ki iyisin gayet."],
        act_flirt: [
            '<32>{#p/human}* (Mankenle flört ediyorsun.)',
            "<32>{#p/basic}* İşler tam olarak tahmin edeceğin gibi gitti.",
            '<32>* Toriel kendini gülmemek için tutuyor.'
        ],
        act_hug: ['<32>{#p/human}* (Mankene sarılıyorsun.)'],
        act_slap: ['<32>{#p/human}* (Mankene vuruyorsun.)'],
        act_talk: [
            '<32>{#p/human}* (Mankene konuşuyorsun.)',
            "<32>{#p/basic}* Sohbet için pek konuşacak bir şeyi varmış gibi görünmüyor.",
            '<32>* Toriel senden memnun.'
        ],
        bored: ['<32>{#p/basic}* Manken amaçsız saçmalıklarından bıktı.'],
        hugged: ['<32>{#p/basic}* Manken bir şekilde... kızarıyor.'],
        name: '* Manken',
        slapped: ['<32>{#p/basic}* Aniden...!'],
        status1: ['<32>{#p/story}* Mankenle karşılaştın.'],
        status2: ["<32>{#p/story}* Manken şimdiden sıkılmış gibi görünüyor."],
        status3: ["<32>{#p/story}* Manken kendinde kaybolmuş gibi görünüyor."],
        status4: ["<32>{#p/story}* Manken olduğu yerde düşecekmiş gibi görünüyor."],
    ...
    b_party_kidd: {
        ...
        mkTurnFight1: () => [
            ...
            choicer.create('* (Do you confirm?)', 'Evet', 'Hayır')
        ],
    ...
    c_name_common: {
        keyring: 'Keyring',
        hello_asgore: 'Merhaba De',
        about_asgore: 'Hakkında',
        dad: 'Call Him \"Dad\"',
        flirt_asgore: 'Flört Et',
        insult_asgore: 'Hakaret Et'
    },

    c_call_common: {
        start: '<32>{#s/phone}{#p/event}* Aranıyor...',
        end: '<32>{#s/equip}{#p/event}* Klik...',
        nobody0: ['<32>{#p/human}* (Hatta çok fazla müdahale.)'],
        nobody1: ['<32>{#p/human}* (Cevap yok.)'],
        nobody2: ['<32>{#p/basic}* ... ama kimse gelmedi.'],
        nobody3: ['<32>{#p/human}* (Bağlantı yok.)'],
        nobody4: [
            '<32>{#p/human}* (Küçük, beyaz bir köpek telefonun üzerinde uyuyor gibi görünüyor.)',
            '<32>{#p/basic}* (Horr... horr...)',
            '<32>* (Horr... horr...)'
        ],
        nobody4a: [
            '<32>{#p/human}* (Küçük, beyaz bir köpek telefonun üzerinde uyuyor gibi görünüyor.)',
            '<32>{#p/basic}* (Horr... horr... horr...)',
            '<32>* (Horr... horr... horr...)'
        ],
        nobody4f: [
            '<32>{#p/human}* (Küçük, beyaz bir köpek telefonun üzerinde uyuyor gibi görünüyor.)',
