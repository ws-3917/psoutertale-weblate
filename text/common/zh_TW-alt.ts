                ...
                if (dmettaton) {
                    ...
                    if (!dundyne) {
                        addB([
                            ...
                            '<32>{#p/napstablook}* ...艾斯戈爾死後，\n  她便繼承了王位。',
                            "<32>{#p/napstablook}* 雖然她不怎麼喜歡鎂塔頓...",
                            '<32>{#p/napstablook}* 但那句「躲不過十五」，\n  讓她產生了共鳴。'
                        ]);
                        if (!dtoriel) {
                            addB([
                                '<32>{#p/napstablook}* 呵......\n  那時，托麗爾走出外域，\n  求安黛因放你一馬...',
                                '<32>{#p/napstablook}* 結果，被安黛因狠狠笑話一通，\n  趕回了外域。',
'<32>{#p/napstablook}* 回去的路上，安黛因就帶領民眾，\n  緊跟在後面嘲諷她，\n  一直笑話到她走回外域。',
                        ...
                        addB([
                            '<32>{#p/napstablook}* 可是，王后托麗爾\n  不太支援我們。',
                            '<32>{#p/napstablook}* ...艾斯戈爾死後，\n  她便繼承了王位。',
                            "<32>{#p/napstablook}* 她認同鎂塔頓的話...",
...
'<32>{#p/mettaton}* 接著，又疏遠了她。',
                            '<32>{#p/mettaton}* 雖然艾菲斯還相信你，\n  覺得你有救...\n  但其他民眾可不這麼想。',
                            '<32>{#p/mettaton}* 出了這些事，\n  他們只想把人類統統殺光。'
                        ]);
                        if (!dtoriel) {
                            addB([
                                "<32>{#p/mettaton}* 過了一陣，托麗爾回歸了。\n* 可她根本勸不動\n  這些怪物。",
                                '<32>{#p/mettaton}* 最終，艾菲斯也心灰意冷，\n  放棄了王位。'
                            ]);
                        }
                    } else if (!dundyne) {
                        addB([
...
'<32>{#p/mettaton}* 說實話，出了這些事，\n  換誰誰這麼想。',
                    ...
                    addB([
                        ...
                        "<32>{#p/mettaton}* 和你沒關係，小幽。",
                        '<32>{#p/napstablook}* 我猜猜......',
                        '<32>{#p/napstablook}* ...\n* 知道了...',
                        '<32>{#p/napstablook}* 嘿...\n* 呃，你傷了我表親的心',
                        '<32>{#p/napstablook}* 一次巧合，我發現鎂塔頓\n  原來是我的表親...',
'<32>{#p/napstablook}* 艾菲斯逃走了，\n  我就開始照顧他。'
                    ...
                    addB([
                        ...
                        "<32>{#p/mettaton}* 我認識的小幽\n  才不會用這種口氣說話，\n  對吧？",
                        "<32>{#p/napstablook}* ......\n* ......我.......",
                        "<36>{#p/mettaton}* 你想讓我開心點，我很高興。\n* 可這事跟你沒啥關係，\n  別惹自己不愉快。",
                        '<32>{#p/napstablook}* 鎂塔頓...',
                ...
                addB([
                    ...
                    "<25>{#p/sans}{#f/0}* 這還沒完，鎂塔頓\n  也來蹚這趟渾水，\n  跟著瞎攪和。",
                    "<18>{#p/papyrus}{#f/6}鎂塔頓？！\n【他】跟著幹啥？",
                    '<25>{#p/sans}{#f/0}* 喔，在艾菲斯當了王，\n  鎂塔頓也想「沾點光」。',
                    "<25>{#p/sans}{#f/3}* 但是他...\n  就沒提過啥正經建議。",
                ...
                if (!dundyne) {
                    ...
                    if (royals < 6 || mdeaths > 9) {
                        ...
                        if (30 <= SAVE.data.n.bully) {
                            addB(['<25>{#p/alphys}{#f/26}* ...緊接著，安黛因把你\n  揍他們的事拎了出來。',
'<25>{#p/alphys}{#f/26}* 結果...\n  民眾立馬變卦，紛紛支援她。']);
                        } else {
                            addB([
                                '<25>{#p/alphys}{#f/20}* ...看他們不信，安黛因又說，\n  是你把艾斯戈爾殺了。',
'<25>{#p/alphys}{#f/26}* 結果，\n  民眾立馬變卦，紛紛支援她。'
                            ]);
                        }
                    }
                    ...
                    if (dtoriel) {
                        ...
                        if (dpapyrus) {
                            ...
                            addB([
                                ...
                                "<25>{#p/alphys}{#f/8}* 帕派瑞斯，給人類講講\n  你的新工作吧。",
                                '<18>{#p/papyrus}{#f/0}啊對！！\n我咋把這事忘了呢！？',
                                '<18>{#p/papyrus}{#f/0}終於啊... 安黛因同意\n讓我當皇家守衛了。',
...
'<25>{#p/toriel}{#f/9}* 他們才懶得區分\n  誰是「敵人」，誰是「朋友」。\n* 反正只要是人類，都得死。',
                                '<32>{#p/human}{#v/1}{@fill=#42fcff}* 托麗爾，我好怕...',
...
'<25>{#p/sans}{#f/0}* 上周，一群怪物闖進他的店，\n  把店洗劫一空。',
                        ...
                        addB([
                            ...
                            '<25>{#p/toriel}{#f/1}* 我們從艾斯戈爾說到人類...',
                            '<25>{#p/toriel}{#f/3}* 又從人類聊到\n  什麼「喵喵航天行」...',
                            '<25>{#p/toriel}{#f/4}* 我到現在都沒搞懂\n  那到底是個啥玩意。',
                            "<25>{#p/toriel}{#f/0}* 總之...\n  她並不想當女王。",
                            '<25>{#p/toriel}{#f/1}* 艾菲斯覺得，\n  我來統治這裡更合適。',
                        ...
                        if (hkills === 0) {
                            ...
                            addB(['<25>{#p/toriel}{#f/9}* 電視大明星鎂塔頓\n  也死了。']);
                            if (royals < 2) {
                                addB([
                                    '<26>{#p/toriel}{#f/9}* ...而皇家衛隊\n  也幾乎全軍覆沒。',
                                    "<25>{#p/toriel}{#f/5}* 對她來說，鎂塔頓的死\n  帶來的打擊尤為強烈。"
                                ]);
                            } else if (royals < 7) {
                                addB([
                            ...
                            addB(['<25>{#p/toriel}{#f/9}* 犬衛隊成員，遁狗\n  也死了。']);
                        } else if (dlesserdog) {
                            addB(['<25>{#p/toriel}{#f/9}* 犬衛隊成員，小犬座\n  也死了。']);
                        } else if (ddogs) {
                            addB(['<25>{#p/toriel}{#f/9}* 犬衛隊成員，\n  狗來米和狗媳兒\n  也死了。']);
                        } else if (dgreatdog) {
                            addB(['<25>{#p/toriel}{#f/9}* 犬衛隊成員，大犬座\n  也死了。']);
                        } else if (ddoge) {
                            addB(['<25>{#p/toriel}{#f/9}* 特戰隊成員，督吉\n  也死了。']);
                        } else if (droyalguards) {
                            addB(['<25>{#p/toriel}{#f/9}* 新來的兩名守衛，\n  三號和四號\n  也死了。']);
                        } else if (dmadjick) {
                            addB(['<25>{#p/toriel}{#f/9}* 特戰隊成員，謎宇人\n  也死了。']);
                        } else if (dknightknight) {
                            addB(['<25>{#p/toriel}{#f/9}* 特戰隊成員，特雷莉亞\n  也死了。']);
                        } else if (mdeaths > 9) {
                    ...
                    addB([
                        '<32>{#p/basic}* 等等！！\n* 我的人類過來了！！',
                        '<32>{#p/human}{#v/3}{@fill=#003cff}* 遁狗長官！\n* 遁狗長官！\n* 快過來快過來，有好看的！',
                        '<32>{#p/basic}* 啥事啊這麼急。',
...
'<32>{#p/basic}* 大隊長一死，那群廢物守衛\n  立馬沒了凝聚力~\n  一個個自以為是，誰也不服誰~',
                    ...
                    addB([
                        "<32>{#p/basic}{#s/spiderLaugh}* 呦，這不是艾菲斯小親親嘛~\n* 今天讓你清理水管，\n  怎麼還不去呢？",
                        "<32>{#p/basic}* 過了這麼久...\n  那裡面肯定又髒又臭~",
                        "<32>{#p/basic}* 你不去，誰去呢？"
                    ]);
                    if (royals < 2) {
                        ...
                        addB([
                            ...
                            '<32>{#p/basic}{#s/spiderLaugh}* 不用狡辯啦，艾菲斯小親親~\n* 既然這麼想被電，\n  那我肯定不會「虧待」你！',
                            '<32>{#p/basic}* 蜘蛛們，把她拖出去！',
                            '<32>{#p/basic}* 我們的艾菲斯想去\n  「極光區」再體驗一把\n  高能射線的快感呢~',
                    ...
                    addB([
                        ...
                        "<18>{#p/papyrus}{#f/6}大家都想讓艾菲斯\n繼承王位...",
                        "<18>{#p/papyrus}{#f/5}可她根本不想當女王。",
                        "<18>{#p/papyrus}{#f/5}大夥又到處找安黛因，\n可就是找不到...",
                    ...
                    addB([
                        ...
                        "<18>{#p/papyrus}{#f/0}喔，是衫斯呀！\n今兒個咋這麼\n有精神呢？",
                        '<25>{#p/sans}{#f/0}* 喔，今天不用上班。',
                        "<25>{#p/sans}{#f/3}* 畢竟過節嘛。",
                        '<18>{#p/papyrus}{#f/4}過節？\n然後就放假了？',
                        '<18>{#p/papyrus}{#f/5}（唉...）',
                        
                        "<18>{#p/papyrus}{#f/4}自打你去烤爾比\n那裡幹活，\n放的假就越來越多...",
...
'<18>{#p/papyrus}{#f/6}萬一你哪天回來了...\n我一定會讓你倆\n重歸於好！！',
                ...
                addB([
                    ...
                    "<18>{#p/papyrus}{#f/5}據說，鎂塔頓要徹底拋棄\n他的「舊商標」了。",
                    '<18>{#p/papyrus}{#f/4}轉而啟用「鎂塔視界」新商標。',
...
'<32>* 不要再想了。'
            ...
            _frontier10: pager.create(
                ...
                [
                    "<32>{#p/basic}* 艾斯戈爾把他倆的房間\n  弄得這麼小，只能說...\n  意料之中。",
                    "<32>* 他可了解怪物的性格了。\n  「甭管是大是小，只要躺著得勁，\n   就是好臥室。」",
                    "<32>* 對怪物來說，簡直太對了！"
                ],
                ['<32>{#p/basic}* ...', '<32>* 難怪艾斯利爾昨晚\n  不睡自己的床，\n  跑過來跟你一起睡，'],
                []
            ),
            _void: pager.create(
                0,
        ...
        balcony0: ['<25>{#p/kidd}{#f/3}* 喔，是你呀，弗裡斯克...', '<25>{#f/1}* 我還擔心你醒不過來呢！'],
        balcony1: () => [
            '<25>{#p/kidd}{#f/3}* ...哈哈。',
            ...(SAVE.data.b.ufokinwotm8
                ? ["<25>{#f/2}* 我做夢都沒想到，\n  自己...", '<25>{#f/4}* ...也...']
        ...
        balcony8a: ['<25>{#p/kidd}{#f/4}* 艾斯利爾...？', '<25>{#p/kidd}{#f/4}* 你還好嗎？'],
        balcony9a: [
        ...
        balcony24a: ["<33>{#p/basic}* 艾斯利爾，我在這站了這麼久，\n  你為啥一直沒看見？\n* 我也沒跟你玩躲貓貓啊！"],
        balcony25a: ['<26>{#p/asriel1}{#f/23}* ...$(name)，我...'],
        balcony26a1: [
            "<32>{#p/basic}* 沒關係的，艾斯利爾。\n* 別自責，別難過。",
            '<32>* 要是想哭... 就哭吧。',
...
'<32>* 懂了吧？'
        ...
        balcony29a: ['<25>{#p/kidd}{#f/14}* ...艾斯利爾是你的兄弟？！', '<25>{#p/kidd}{#f/4}* 資訊量太大，有點接受不了...'],
        ...
        balcony34a2: ['<25>{#p/asriel1}{#f/15}* ...你剛剛...', '<33>{#p/basic}* 是的，艾斯利爾。\n  怪物小孩剛剛說的，\n  就是那兩句話。'],
        balcony35a1: [
...
'<32>* 說來說去，就是一句話：\n  「放開了玩。」'
            ...
            x_booktable: () =>
                SAVE.data.b.ufokinwotm8
                    ...
                    : [
                        ...
                        '<32>{#p/human}* （日記只寫了一篇，\n  你讀了讀內容...）',
                        '<32>{#p/kidding}* 「艾斯戈爾現在成我爹啦！」\n* 「總覺得有點怪怪的，\n   但也超級棒！」',
                        '<32>{#p/kidding}* 「艾斯戈爾說，我得換一身新衣服，\n   一會我就去換吧。」',
                        '<32>{#p/kidding}* 「他還給了我一本日記，\n   讓我記錄一下生活。」',
                        '<32>{#p/kidding}* 「寫日記可難不倒我，\n   我認識的字可多了！」',
                        '<32>{#p/kidding}* 「要是我那裡寫了錯別字，\n  還有弗裡斯克幫我糾正呢！」',
                        '<32>{#p/kidding}* 「弗裡斯克，看完後\n  別忘了給我圈一下\n  錯別字喔。」',
                        '<32>{#p/human}* （你合上了日記。）'
                    ],
            x_bed_left: () => [
                ...(SAVE.data.b.svr || SAVE.data.b.ufokinwotm8
    ...
    b_opponent_spacetop: {
        ...
        act_check: () =>
            world.goatbro
                ...
                : ["<32>{#p/story}* 太空帽 - 攻擊11 防禦4\n* 這個青年想知道自己為啥不叫\n  「收音劫克」。"],
        act_check2: ['<32>{#p/story}* 太空帽 - 攻擊11 防禦4\n* 這個青年很欣賞你的時尚感。'],
        act_check3: ['<32>{#p/story}* 太空帽 - 攻擊11 防禦4\n* 這個青年\n  找到了所有正確的訊號。'],
        act_check4: [
            '<32>{#p/story}* 太空帽 - 攻擊11 防禦4\n* 企圖劫持一個收音機\n  來尋求幫助。'
        ],
        act_compliment: ['<32>{#p/human}* （你說太空帽的天線\n  真是太棒了。）'],
        act_flirt: ['<32>{#p/human}* （你向太空帽調情。）'],
        ...
        flirtStatus1: ['<32>{#p/story}* 太空帽不喜歡你的裝束。'],
        flirtStatus2: ['<32>{#p/story}* 太空帽墜入愛河。'],
        ...
        randStatus2: ['<32>{#p/story}* 太空帽檢查了一下\n  他的天線還在是否那裡。'],
    ...
    b_opponent_space: {
        ...
        name: '* 鋰塊',
        randStatus1: ['<32>{#p/story}* 再也沒有「太空帽」了。'],
