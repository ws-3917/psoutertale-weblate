                ...
                iRespeccYourVilliany()
                    ...
                    : SAVE.data.n.state_foundry_muffet === 1
                        ? SAVE.data.b.colleg
                            ...
                            : ['<32>{#p/tem}* 卜...', '<32>* tem没油事...', '<32>* 记得来光顾TEM商店！！']
                        : SAVE.data.b.f_state_kidd_betray
...
'<32>{#p/mettaton}{#e/mettaton/16}* 唯一就是偶尔问一句\n  “嘿，你啥时候回来工作？”',
            ...
            hapsta73: ['<32>{#p/finalghost}* Blooky，干得不错。', '<32>{#p/finalghost}* 干得不错。'],
                    ...
                    : [
                        ...(!SAVE.storage.inventory.has('tvm_mewmew') && // NO-TRANSLATE
                            ...
                            : [
                                ...
                                '<25>{#f/10}* 你能不能... 把我的\n  喵喵玩偶还给我呢？',
                                '<25>{#f/3}* 求你了？',
                                choicer.create('* （把喵喵玩偶还给Alphys？）', '还给她', '才不要')
                            ])
                    ])
            ],
            opera36b1: [
                '<32>{#p/human}* （你把喵喵玩偶递给了Alphys。）',
            ...
            endwalk2: () =>
                !world.baddest_lizard
                    ? [
                        ...
                        '<25>* ...',
                        '<25>{#g/alphysFR}* 简单来说...',
                        "<25>{#g/alphysFR}* ASGORE有一个{@fill=#003cff}秘密{@fill=#fff}。"
                    ]
                    : [
                        ...(SAVE.data.n.state_foundry_undyne === 2
                            ? [
...
'<32>* “当前的真实时间\n   应为克历625年9月。”'
            ...
            nuzzle: () =>
                [
                    ['<25>{#p/asriel1}{#f/13}* Frisk...？', '<25>{#p/asriel1}{#f/17}* 一个私密空间...'],
                    ['<25>{#p/asriel1}{#f/18}* 什—\n* Frisk！', '<25>{#p/asriel1}{#f/18}* 你刚才...\n  是不是戳了下我的鼻子？'],
                    ['<25>{#p/asriel1}{#f/18}* 啊—\n* 好痒啊，Frisk!'],
...
'<32>* 但我知道，你一直坚守本心，\n  做最棒的自己。\n* 直到最后一刻。',
        ...
        npc: {
            ...
            picnic_darkman2: pager.create(
                ...
                [
                    '<32>{#p/basic}{#npc/a}* 我的召唤师Cozmo曾经说过...',
                    "<32>* 我们就像他们人格的一部分，\n  可以脱离他们的身体。",
                    "<32>* 还有——...\n  有事需要做时\n  我们就会脱离出来。",
                    "<32>* 我出来是因为在出发前\n  看看前哨站会很酷。",
                    "<32>* 当你情绪很激动时，\n  你呃——...\n  什么都不能做。"
                        ...
                        : SAVE.data.n.plot < 68
                            ...
                            : world.bad_robot
                                ...
                                : SAVE.data.b.killed_mettaton
                                    ...
                                    : [
                                        "<32>{#p/basic}{#npc/a}* 老兄，Mettaton还在这，真好。",
                                        "<32>* 要不是他，\n  我哪来这么多借口翘课。"
                                    ],
                () =>
                    SAVE.data.n.plot < 60
    ...
    b_opponent_glyde: {
        ...
        act_check: ['<32>{#p/story}* GLYDE - 攻击嗯 防御嗯\n* 拒绝提供详细面板数据。'],
        act_secret: () =>
            glade()
        ...
        act_flirt1: ['<32>{#p/human}* （你向Glyde调情。）'],
        act_flirt2: ["<32>{#p/human}* （你向Glyde调情，\n  可他压根不理你。）"],
        ...
        turnStatus1: ['<32>{#p/story}* Glyde看见自己的倒影，\n  心生嫉妒。'],
        turn2: [
        ...
        turnStatus4: ['<32>{#p/story}* Glyde做了个花式空翻。'],
        turn5: () => [
            iFancyYourVilliany()
        ...
        turnStatus5: ['<32>{#p/story}* Glyde在和自己击掌...\n  管它怎么做到的。'],
    ...
    b_opponent_astigmatism: {
        ...
        act_check3: ['<32>{#p/story}* EYEWALKER PRIME - 攻击32 防御26\n* 觉得你现在很“顺眼”。'],
        act_check4: [
        ...
        partialStatus1: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ...
                    : ['<32>{#p/alphys}* ...']
                : ['<32>{#p/story}* Eyewalker Prime还没看够。'],
        partialStatus2: () =>
            !world.badder_lizard
                ? calm_lizard()
    ...
    b_opponent_mushketeer: {
        ...
        act_travel3: () => [
            '<32>{#p/human}* （可是，你都快贴上Mushketeer了。）',
            ...(world.genocide
                ? ['<32>{#p/asriel2}* 我有点担心了。']
                : !world.badder_lizard && calm_lizard()
    ...
    b_opponent_pyrope: {
        ...
        act_check3: ["<32>{#p/story}* HOTWIRE - 攻击29 防御14\n* 这个冒烟蠢货的押韵词容易着火。"],
        act_check4: ['<32>{#p/story}* HOTWIRE - 攻击29 防御14\n* 重新点燃了对说唱的热爱，每次一句。'],
    ...
    b_opponent_perigee: {
        ...
        act_check3: ['<32>{#p/story}* PERIGEE - 攻击25 防御0\n* 既是和平之鸟，\n  亦是艺术之守护神。'],
        act_check4: [
            '<32>{#p/story}* PERIGEE - 攻击25 防御0\n* 这只和平之鸟\n  欣赏着你那柏拉图式的情歌。'
        ],
        act_flirt: ['<32>{#p/human}* （你向Perigee调情。）'],
        ...
        status1: ['<32>{#p/story}* 你进入了Perigee的轨道附近。'],
        status2: ['<32>{#p/story}* Perigee的生活无忧无虑。'],
        status3: ['<32>{#p/story}* Perigee非常开心。'],
        status4: ['<32>{#p/story}* Perigee以羽毛轻触。'],
        status5: ['<32>{#p/story}* 闻起来像备用面包。'],
        status6: () =>
            world.goatbro ? ["<32>{#p/asriel2}* 不堪一击。"] : ['<32>{#p/story}* Perigee非常满足。'],
        hurtStatus: () =>
    ...
    b_opponent_tsundere: {
        ...
        flirtText4: ['<32>{#p/human}* （你告诉Tsunderidex，\n  你喜欢它在虚拟小说上的品味。）'],
        flirtText5: ['<32>{#p/human}* （你告诉Tsunderidex，\n  它拥有可爱的引擎支柱。）'],
        flirtText6: ["<32>{#p/human}* （你告诉Tsunderidex，\n  你想给它的电容器增压。）"],
        flirtText7: ["<32>{#p/human}* （你告诉Tsunderidex，\n  你想把它擦得闪闪发光。）"],
        flirtText8: ['<32>{#p/human}* （你告诉Tsunderidex，\n  你们应该用鼻子互相轻蹭对方。）'],
        flirtText9: ['<32>{#p/human}* （你告诉Tsunderidex，\n  它的顶铲是完美无缺的。）'],
        flirtText10: ['<32>{#p/human}* （你告诉Tsunderidex，\n  它有一个令人惊叹的机翼。）'],
        flirtText11: ['<32>{#p/human}* （你告诉Tsunderidex，\n  它拥有迷人的光管。）'],
        flirtText12: ["<32>{#p/human}* （你告诉Tsunderidex，\n  你想去一个没有人类\n  去过的地方。）"],
        stealText: ['<32>{#p/human}* （你靠近了Tsunderidex，\n  并抽取它的电池能量。）'],
        upgradeText1: ["<32>{#p/human}* （你激活了Tsunderidex引擎的\n  滑流飞行模块。）"],
        upgradeText2: ["<32>{#p/human}* （你激活了Tsunderidex大炮的\n  超相位发射机制。）"],
        upgradeText3: ["<32>{#p/human}* （你激活了Tsunderidex护盾的\n  自适应调节。）"],
        upgradeText4: [
            "<33>{#p/human}* （你无法再激活了。）\n* （Tsunderidex的主体部位\n  已全部激活。）"
        ],
        ...
        status5: () =>
            world.goatbro ? ['<32>{#p/asriel2}* Tsunderidex。'] : ['<32>{#p/story}* 闻起来像太空仙人掌。'],
        status6: () =>
            world.goatbro
                ? ["<32>{#p/asriel2}* 不堪一击。"]
