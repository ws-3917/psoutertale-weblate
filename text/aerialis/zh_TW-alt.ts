...
'<32>{#p/basic}* 這些光圈能證明，\n  就算老闆炒我魷魚，\n  我也肯定能復職的...'
                ...
                iRespeccYourVilliany()
                    ...
                    : SAVE.data.n.state_foundry_muffet === 1
                        ? SAVE.data.b.colleg
                            ...
                            : ['<32>{#p/tem}* 卜...', '<32>* 提咪沒油事...', '<32>* 記得來光顧提咪商店！！']
                        : SAVE.data.b.f_state_kidd_betray
            ...
            moneyFinal4: () => [
                ...(SAVE.data.n.state_foundry_undyne === 1
                    ? [
                        '<32>{#p/event}* 鈴鈴，鈴鈴...',
                        "<25>{#p/alphys}{#g/alphysOhGodNo}{#z0}* 喂，鎂塔頓！\n* 你這是在往我傷口上\n  撒鹽嗎？！",
                        '<32>{#p/mettaton}* ...',
                        "<32>* 好吧，太遺憾了！\n* 因為，你們也知道..."
                    ]
                    : [
            ...
            moneyTrash1: ['<32>* 等等，小幽，你這是上哪...', '<32>* ...去...', '<32>{#z1}* ...'],
            moneyTrash2: ["<32>{#z0}* 看來小幽不想\n  呆在這了。"],
                    ...
                    : [
                        ...(!SAVE.storage.inventory.has('tvm_mewmew') && // NO-TRANSLATE
                            ...
                            : [
                                ...
                                '<25>{#f/10}* 你能不能... 把我的\n  喵喵玩偶還給我呢？',
                                '<25>{#f/3}* 求你了？',
                                choicer.create('* （把喵喵玩偶還給艾菲斯？）', '還給她', '才不要')
                            ])
                    ])
            ],
            opera36b1: [
                '<32>{#p/human}* （你把喵喵玩偶遞給了艾菲斯。）',
            ...
            endwalk2: () =>
                !world.baddest_lizard
                    ? [
                        ...
                        '<25>* ...',
                        '<25>{#g/alphysFR}* 簡單來說...',
                        "<25>{#g/alphysFR}* 艾斯戈爾有一個{@fill=#003cff}秘密{@fill=#fff}。"
                    ]
                    : [
                        ...(SAVE.data.n.state_foundry_undyne === 2
                            ? [
                                    ...
                                    : SAVE.data.n.plot < 56
                                        ...
                                        : SAVE.data.n.plot < 58
                                            ...
                                            : SAVE.data.n.plot < 59
                                                ...
                                                : SAVE.data.n.plot < 60
                                                    ? [
                                                        "<25>{#p/alphys}{#g/alphysCutscene2}* 我覺得鎂塔頓\n  正在準備另一個節目。",
                                                ...
                                                : SAVE.data.n.plot < 60
                                                    ...
                                                    : SAVE.data.n.plot < 61
                                                        ...
                                                        : SAVE.data.n.plot < 67.1
                                                            ...
                                                            : ['<25>{#p/alphys}{#g/alphysCutscene3}* 鎂塔頓現在一定在\n  耐心等待著你。']
                )
            },
...
'<32>* 「當前的真實時間\n   應為克歷625年9月。」'
            ...
            nuzzle: () =>
                [
                    ['<25>{#p/asriel1}{#f/13}* 弗裡斯克...？', '<25>{#p/asriel1}{#f/17}* 一個私密空間...'],
                    ['<25>{#p/asriel1}{#f/18}* 什—\n* 弗裡斯克！', '<25>{#p/asriel1}{#f/18}* 你剛才...\n  是不是戳了下我的鼻子？'],
                    ['<25>{#p/asriel1}{#f/18}* 啊—\n* 好癢啊，弗裡斯克!'],
                    ['<25>{#p/asriel1}{#f/18}* 弗裡斯克——！'],
                    ['<25>{#p/asriel1}{#f/17}* ... 弗裡斯克...\n* ... 不要啦...'],
                    ["<25>{#p/asriel1}{#f/20}* ...你真可愛，\n  弗裡斯克。"],
                    ['<25>{#p/asriel1}{#f/13}* 呃，弗裡斯克，\n  你可以停下來了。'],
...
'<32>* 但我知道，你一直堅守本心，\n  做最棒的自己。\n* 直到最後一刻。',
        ...
        npc: {
                    ...
                    SAVE.data.n.plot < 60
                        ...
                        : SAVE.data.n.plot < 68
                            ...
                            : world.bad_robot
                                ...
                                : SAVE.data.b.killed_mettaton
                                    ? [
                                        "<32>{#p/basic}{#npc/a}* 老兄，鎂塔頓死了。\n* 挺難過的...",
                                        "<32>* 這下來悼念他，我還能翹會課，\n  但這事過去後，我就完了啊！"
                                    ]
                                    : [
                                        "<32>{#p/basic}{#npc/a}* 老兄，鎂塔頓還在這，真好。",
                                        "<32>* 要不是他，\n  我哪來這麼多藉口翹課。"
                                    ],
                () =>
                    SAVE.data.n.plot < 60
            ...
            a_pyrope: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ...
                        : [
                            '<32>{#p/basic}{#npc/a}* 迷你火山和我組了個說唱組合\n  叫「熱火朝天」。',
                            '<32>* 唱一首天籟你最帥。\n* 來一段搖擺一起嗨。',
                            "<33>* 聽我妙語連炸就等我登上舞臺，\n  瞧觀眾被我絕殺看你作何抵賴。",
                            "<32>* 至於迷你火山？\n* 人家出招完爆求饒拉倒\n  讓你氣惱承認自己的失敗。"
                        ],
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ...
                        : SAVE.data.b.ubershortcut
                            ...
                            : SAVE.data.n.plot < 68
                                ? [
                                    "<32>{#p/basic}{#npc/a}* 我們是來看鎂塔頓的大結局的，\n  但是...",
                                    ...(iFancyYourVilliany()
                                        ? [
                                            "<32>* 我沒想到我可以這麼近距離地\n  看到$(moniker1)！",
                                            '<32>* ...你就是$(moniker1)，是吧？'
                    ...
                    SAVE.data.n.plot === 72
                        ...
                        : SAVE.data.b.ubershortcut
                            ...
                            : SAVE.data.n.plot < 68
                                ...
                                : SAVE.data.b.killed_mettaton
                                    ? ["<32>{#p/basic}{#npc/a}* 鎂塔頓他竟然真的...\n* 永遠離開了我們...", '<32>* ...']
                                    : [
                                        '<32>{#p/basic}{#npc/a}* 鎂塔頓最後真的把我們\n  都騙到了...',
            ...
            a_giftbear: pager.create(
                ...
                () =>
                    SAVE.data.n.plot === 72
                        ? [
                            '<32>{#p/basic}{#npc/a}* 我開始覺得我對禮物鹿的同情\n  有點過於推己及人了。',
                            '<32>* 從我記事起，\n  我就很渴望一個\n  寒冷的居住環境...',
                            '<32>* 當我們到達新家園時，\n  我會去找一個。'
                        ]
                        : [
                            '<32>{#p/basic}{#npc/a}* 我為禮物鹿感到難過。\n* 和我們許多人一樣，它從來\n  沒在自己的自然棲息地生活過。',
                            '<32>* 艾菲斯最近說過\n  力場很快就會崩潰。',
                            '<32>* 也許當那發生時，\n  我們就都可以休息一下了。'
                        ],
                () =>
                    SAVE.data.n.plot === 72
                        ? [
                            "<32>{#p/basic}{#npc/a}* 目前，我仍將繼續陪伴禮物鹿。\n* 送禮物是我唯一知道的\n  互動方式。"
                        ]
                        : [
        ...
        pyropeTsundereX: (pyrope: boolean) =>
            world.goatbro
                ...
                : pyrope
                    ...
                    : ['<32>{#p/story}* 這裡只剩傲嬌飛船了。'],
        astigmatismMigospelX: ['<32>{#p/story}* 眼行者長老掌控了戰局！']
    },

    b_opponent_glyde: {
        name: '* 老滑頭',
        epiphaNOPE: ['<11>{#p/basic}{~}{#e/glyde/10}別把\n那玩意\n湊我臉上，\n成不成？'],
        act_check: ['<32>{#p/story}* 老滑頭 - 攻擊嗯 防禦嗯\n* 拒絕提供詳細面板數據。'],
        act_secret: () =>
            glade()
                ? SAVE.data.b.w_state_steak && SAVE.data.b.w_state_soda
                    ? ['<32>{#p/human}* （你把亞倫告訴你的密碼\n  報給了老滑頭.）']
                    : ["<32>{#p/human}* （你想把密碼報給老滑頭，\n  可你根本不知道什麼密碼。）"]
                : ['<33>{#p/human}* （你想把密碼報給老滑頭，\n  可他搖搖頭，打斷了。）'],
        act_flirt1: ['<32>{#p/human}* （你向老滑頭調情。）'],
        act_flirt2: ["<32>{#p/human}* （你向老滑頭調情，\n  可他壓根不理你。）"],
        ...
        turnStatus4: ['<32>{#p/story}* 老滑頭做了個花式空翻。'],
        turn5: () => [
            iFancyYourVilliany()
                ? '<20>{#p/basic}{#p/basic}{~}{#e/glyde/6}有臭名昭著的\n「$(moniker2)」幫我打廣告，\n銷售額還用愁嗎？\n那時，誰都阻止不了我！'
                : "<20>{#p/basic}{#p/basic}{~}{#e/glyde/6}有鎂塔頓的掌上明珠\n幫我打廣告，\n銷售額還用愁嗎？\n那時，誰都阻止不了我！",
        ...
        turnStatus5: ['<32>{#p/story}* 老滑頭在和自己擊掌...\n  管它怎麼做到的。'],
    ...
    b_opponent_mettaton1: {
        ...
        act_burn: ['<32>{#p/human}* （你嘲笑鎂塔頓在自己的\n  電視節目表現得有多爛。）'],
    ...
    b_opponent_mettaton2: {
        ...
        turnTalkX0a: () =>
            SAVE.data.b.a_state_hapstablook
                ? [
                    ...
                    '<20>{#p/mettaton}{#e/mettaton/10}你，還有匿羅\n永遠都是我的親人！',
        ...
        audienceRec3c: () =>
            iFancyYourVilliany()
                ...
                : ["<21>{#e/mettaton/10}{#p/basic}我的鎂塔頓形狀的\n心臟上空缺了一個\n鎂塔頓形狀的洞！"],
        audienceRec4: () => [
    ...
    b_opponent_astigmatism: {
        ...
        genostatus: ['<32>{#p/asriel2}* ...'],
        old_gun_text: ['<32>{#p/human}* （你開了一槍。）', '<32>{#p/basic}* 眼行者長老被擊倒了！'],
        old_bomb_text: [
            '<32>{#p/human}* （你引爆了炸彈。）\n* （雲霧繚繞。）',
            '<32>{#p/basic}* 眼行者長老被擊倒了！'
        ],
        old_spray_text: [
            '<32>{#p/human}* （你噴灑了糖霧。）\n* （好甜...）',
            '<32>{#p/basic}* 眼行者長老被擊倒了！'
        ...
        act_check: () =>
            world.goatbro && SAVE.data.n.plot > 66.2
                ...
                : !world.badder_lizard
                    ? calm_lizard()
                        ? ["<32>{#p/alphys}* 眼行者長老...？\n* 大概是眼行者一族的領袖吧。"]
                        : ["<32>{#p/alphys}* 這只是眼行者長老而已。"]
                    : ["<33>{#p/story}* 眼行者長老 - 攻擊32 防禦26\n* 這個怪物比看起來還要難應付。"],
        act_check2: [
            '<33>{#p/story}* 眼行者長老 - 攻擊32 防禦26\n* 很滿意你對家族傳統的遵循。'
        ],
        act_check3: ['<32>{#p/story}* 眼行者長老 - 攻擊32 防禦26\n* 覺得你現在很「順眼」。'],
        act_check4: [
            '<32>{#p/story}* 眼行者長老 - 攻擊32 防禦26\n* 對這個怪物而言，\n  傳統總是比安全更重要。'
        ],
        act_stare: ['<32>{#p/human}* （你緊盯著眼行者長老。）'],
        act_smile: ['<32>{#p/human}* （你對著眼行者長老微笑。）'],
        act_flirt: () => [
            '<32>{#p/human}* （你對著眼行者長老眨眼。）',
            ...(!world.badder_lizard && calm_lizard() ? ['<32>{#p/alphys}* 噢，得了吧。'] : [])
        ],
        status1: () =>
            !world.badder_lizard
                ? ['<32>{#p/alphys}* ...']
                : ['<32>{#p/story}* 眼行者長老正凝視著你的靈魂。'],
        status2: () =>
            !world.badder_lizard
                ? ['<32>{#p/alphys}* ...']
                : ['<32>{#p/story}* 眼行者長老露出了\n  兇狠的笑容。'],
        status3: () =>
            !world.badder_lizard ? ['<32>{#p/alphys}* ...'] : ["<32>{#p/story}* 眼行者長老可不是省油的燈。"],
        status4: () =>
            !world.badder_lizard
                ? ['<32>{#p/alphys}* ...']
                : ["<32>{#p/story}* 眼行者長老想到了\n  他們家族的榮譽。"],
        ...
        perilStatus: () =>
            !world.badder_lizard ? ['<32>{#p/alphys}* 呃...'] : ['<32>{#p/story}* 眼行者長老在流淚。'],
        ...
        partialStatus1: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ...
                    : ['<32>{#p/alphys}* ...']
                : ['<32>{#p/story}* 眼行者長老還沒看夠。'],
        partialStatus2: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ? ['<32>{#p/alphys}* 看到你微笑地盯著他們，\n  眼行者家族很高興。']
                    : ['<32>{#p/alphys}* ...']
                : ['<32>{#p/story}* 眼行者長老想要看穿全局。'],
        partialStatus3: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ? ['<32>{#p/alphys}* 幹-幹點別的吧！']
                    : ['<32>{#p/alphys}* ...']
                : ["<32>{#p/story}* 眼行者長老希望你能\n  聽從它的指示。"],
        fullStatus: () =>
            !world.badder_lizard
                ? calm_lizard()
                    ? ['<32>{#p/alphys}* 現在，眼行者長老\n  看起來很滿意...']
    ...
    b_opponent_mushketeer: {
        ...
        act_check: () =>
            world.genocide
                ? ['<32>{#p/asriel2}* 蘑炮手，火槍手。\n* 遠方蘑菇的髒表親...']
                : !world.badder_lizard
                    ? calm_lizard()
                        ? ['<32>{#p/alphys}* 蘑炮手。\n* 我不知道這是誰。']
                        : ["<32>{#p/alphys}* 這只是蘑炮手罷了。"]
                    : ['<32>{#p/story}* 蘑炮手 - 攻擊30 防禦28\n* 擁有特殊的成長經歷。\n* 火槍手。'],
        act_check2: ['<32>{#p/story}* 蘑炮手 - 攻擊30 防禦28\n* 正在反思自己的成長經歷。\n* 半吊子火槍手。'],
        act_check3: ['<32>{#p/story}* 蘑炮手 - 攻擊30 防禦28\n* 忘記了自己的成長經歷。\n* 心暖花開。'],
        act_check4: ['<32>{#p/story}* 蘑炮手 - 攻擊30 防禦28\n* 蘑菇的字典裡，\n  從來沒有「退縮」二字。'],
        act_flirt: () => [
    ...
    b_opponent_pyrope: {
        ...
        act_check: () =>
            world.goatbro
                ...
                : ['<32>{#p/story}* 烈焰熱線 - 攻擊29 防禦14\n* 這種怪物很狡猾，\n  任何計畫對它來說都不複雜。'],
        act_check2: [
            '<32>{#p/story}* 烈焰熱線 - 攻擊29 防禦14\n* 這個怪物點燃的火花正在熄滅。'
        ],
        act_check3: ["<32>{#p/story}* 烈焰熱線 - 攻擊29 防禦14\n* 這個冒煙蠢貨的押韻詞容易著火。"],
        act_check4: ['<32>{#p/story}* 烈焰熱線 - 攻擊29 防禦14\n* 重新點燃了對說唱的熱愛，每次一句。'],
    ...
    b_opponent_perigee: {
        ...
        act_check: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 呦呦雞，一隻傻鳥，\n  跟死豬似的。\n* 成天淨知道做白日夢。']
                : ['<32>{#p/story}* 呦呦雞 - 攻擊25 防禦0\n* 這隻和平之鳥相信\n  它的羽毛能治癒一切創傷。'],
        act_check2: [
            '<33>{#p/story}* 呦呦雞 - 攻擊25 防禦0\n* 這隻和平之鳥正試著\n  用自己的羽毛來治療自己。'
        ],
        act_check3: ['<32>{#p/story}* 呦呦雞 - 攻擊25 防禦0\n* 既是和平之鳥，\n  亦是藝術之守護神。'],
        act_check4: [
            '<32>{#p/story}* 呦呦雞 - 攻擊25 防禦0\n* 這隻和平之鳥\n  欣賞著你那柏拉圖式的情歌。'
        ],
        act_flirt: ['<32>{#p/human}* （你向呦呦雞調情。）'],
        ...
        whistleStatus: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 呦呦雞。'] : ['<32>{#p/story}* 呦呦雞等待著你的回應。'],
        act_bow1: ['<32>{#p/human}* （但沒有什麼可以鞠躬。）'],
        act_bow2: ['<32>{#p/human}* （你鞠了一躬。）\n* （呦呦雞也對你鞠了一躬。）\n* （雙方達成了諒解。）'],
        act_whistle: [
            '<32>{#p/human}* （你吹了一首寧靜的曲子。）\n* （呦呦雞以哨聲回應。）\n* （歌聲餘音繞梁...）'
        ],
        status1: ['<32>{#p/story}* 你進入了呦呦雞的軌道附近。'],
        status2: ['<32>{#p/story}* 呦呦雞的生活無憂無慮。'],
        status3: ['<32>{#p/story}* 呦呦雞非常開心。'],
        status4: ['<32>{#p/story}* 呦呦雞以羽毛輕觸。'],
        status5: ['<32>{#p/story}* 聞起來像備用麵包。'],
        status6: () =>
            world.goatbro ? ["<32>{#p/asriel2}* 不堪一擊。"] : ['<32>{#p/story}* 呦呦雞非常滿足。'],
        hurtStatus: () =>
    ...
    b_opponent_tsundere: {
        ...
        act_check: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 傲嬌飛船，\n  這傢伙，我無話可說。']
                : ['<32>{#p/story}* 傲嬌飛船 - 攻擊25 防禦26\n* 看起來很刻薄，\n  但其實暗地裡很喜歡你？'],
        act_check2: [
            '<32>{#p/story}* 傲嬌飛船 - 攻擊25 防禦26\n* 仰天大嘯出門去，\n  我輩豈是傲嬌姬？'
        ],
        act_check3: ["<32>{#p/story}* 傲嬌飛船 - 攻擊25 防禦26\n* 這個猶豫的情人的引擎\n  現在由你驅動。"],
        act_check4: ['<32>{#p/story}* 傲嬌飛船 - 攻擊25 防禦26\n* 看起來... 很嫉妒。'],
        act_check5: ['<32>{#p/story}* 傲嬌飛船 - 攻擊25 防禦26\n* 隨時會爆發。'],
        act_ignore: ["<32>{#p/human}* （你故意無視了傲嬌飛船\n  的存在。）"],
        flirtText1: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  它擁有引人矚目的護盾。）'],
        flirtText2: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  它擁有很棒的大炮。）'],
        flirtText3: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  它有一個強大的折躍引擎。）'],
        flirtText4: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  你喜歡它在虛擬小說上的品味。）'],
        flirtText5: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  它擁有可愛的引擎支柱。）'],
        flirtText6: ["<32>{#p/human}* （你告訴傲嬌飛船，\n  你想給它的電容器增壓。）"],
        flirtText7: ["<32>{#p/human}* （你告訴傲嬌飛船，\n  你想把它擦得閃閃發光。）"],
        flirtText8: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  你們應該用鼻子互相輕蹭對方。）'],
        flirtText9: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  它的頂鏟是完美無缺的。）'],
        flirtText10: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  它有一個令人驚嘆的機翼。）'],
        flirtText11: ['<32>{#p/human}* （你告訴傲嬌飛船，\n  它擁有迷人的光管。）'],
        flirtText12: ["<32>{#p/human}* （你告訴傲嬌飛船，\n  你想去一個沒有人類\n  去過的地方。）"],
        stealText: ['<32>{#p/human}* （你靠近了傲嬌飛船，\n  並抽取它的電池能量。）'],
        upgradeText1: ["<32>{#p/human}* （你激活了傲嬌飛船引擎的\n  滑流飛行模塊。）"],
        upgradeText2: ["<32>{#p/human}* （你激活了傲嬌飛船大炮的\n  超相位發射機制。）"],
        upgradeText3: ["<32>{#p/human}* （你激活了傲嬌飛船護盾的\n  自適應調節。）"],
        upgradeText4: [
            "<33>{#p/human}* （你無法再激活了。）\n* （傲嬌飛船的主體部位\n  已全部激活。）"
        ],
        ...
        status3: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 傲嬌飛船。']
                : ['<32>{#p/story}* 傲嬌飛船「不小心」地用機艙\n  蹭了下你。'],
        status4: () =>
            world.goatbro
                ? ['<32>{#p/asriel2}* 傲嬌飛船。']
                : ['<32>{#p/story}* 傲嬌飛船將大炮\n  設定為「暈眩」。'],
        status5: () =>
            world.goatbro ? ['<32>{#p/asriel2}* 傲嬌飛船。'] : ['<32>{#p/story}* 聞起來像太空仙人掌。'],
        status6: () =>
            world.goatbro
                ? ["<32>{#p/asriel2}* 不堪一擊。"]
                : ['<32>{#p/story}* 傲嬌飛船面帶羞澀，\n  把目光移開了。'],
                        ...
                        : world.population === 0 || burger()
                            ...
                            : [
                                ...
                                [
                                    ...
                                    "<32>{#k/3}* 還有，更瘋狂的是，\n  老滑頭往我店柜上丟了一沓錢，\n  就要把我拽出來，讓我成為它\n  手下的第一名員工！\n* 就像我是被售賣的一個商品似的！",
                                    "<32>{#k/4}* 當然，鎂塔頓不會\n  輕易放我走的，\n  所以我最後還是留在了這裡。",
                                    '<32>{#k/0}* 最終，老滑頭沒有得到想要的。\n  現在老滑頭只是四處要求人們\n  加入它的「十字軍東徵」。',
                                    '<32>{#k/1}* 喔對了。\n* 如果再發生那樣的事，\n  我可以把燈關掉。',
                                    "<32>{#k/7}* 像那樣害怕黑暗的瘋子\n  無法忍受自己不能掌控\n  自己身處的全部情況。"
                                ],
                                [
                                    "<32>{#p/basic}{#k/4}* 老滑頭那些事\n  能說的我都說了。",
                                    "<32>{#k/7}* 也許在過去的什麼地方\n  隱藏著的什麼東西可以解釋\n  老滑頭為什麼要這樣做...",
                                    "<32>{#k/1}* 但誰知道呢？"
                                ]
