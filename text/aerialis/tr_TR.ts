...
export default {
    a_aerialis: {
        coreterminal: () => [
            ...(SAVE.data.b.svr
                ? ['<32>{#p/human}* (Terminal, erişim levelinin üstünde görünüyor.)']
                : world.runaway
                    ...
                    : [
                        ...
                        ...(!world.genocide && !world.badder_lizard && SAVE.data.b.a_state_corecall && SAVE.data.n.plot < 68
                            ? [
                                ["<25>{#p/alphys}{#g/alphysOhGodNo}* Lütfen onlara dokunma!!"],
                                ['<25>{#p/alphys}{#g/alphysNeutralSweat}* Gerçekten.'],
            ...
            ...(world.meanie && !world.genocide && world.badder_lizard
                ? [
                    "<32>{#p/human}* (Yalnız olduğunu fark ediyorsun.)",
                    "<32>{#p/human}* (Karakolun atmosferini çökerteceğini bilmene rağmen, bir şeyi gözden geçiriyorsun.)",
                    choicer.create('* (Terminali parçala?)', 'Evet', 'Hayır')
                ]
                : [])
        ],
        termsmash1: ['<32>{#p/human}* (Parçalamamaya karar veriyorsun.)'],
        termsmash2: ['<32>{#p/human}* (Bir darbe atıyorsun...)'],
        puzzlenoot1: () => [
        ...
        corndog1: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Buy the Corn Dog for 5G?)', 'Evet', 'Hayır')
            ],
            () => ['<25>{#p/sans}{#f/0}* corn dogs for 5G.', choicer.create('* (Buy the Corn Dog for 5G?)', 'Evet', 'Hayır')]
        ),
        corndog2: [
        ...
        spidershop1: () => [
            SAVE.data.n.plot === 72
                ? choicer.create('* (Leave 36G in the web?)', 'Evet', 'Hayır')
                : choicer.create('* (Leave 56G in the web?)', 'Evet', 'Hayır')
        ],
        spidershop2: [
        ...
        hotelfood0: () =>
            SAVE.data.b.svr
                ? [
                    ...
                    choicer.create('* (Take the food?)', 'Evet', 'Hayır')
                ]
                : ["<33>{#p/basic}* It's a kind of mysterious food.", choicer.create('* (Take the food?)', 'Evet', 'Hayır')],
        hotelfood1: () => [
        ...
        sonic1: () => [
            ...
            choicer.create('* (Equip the Sonic Resonator?)', 'Evet', 'Hayır')
        ],
        sonic2: ["<32>{#p/human}* (You're carrying too much to take that.)"],
        tablaphone1: () => [
            '<32>{#p/human}* (You got the Tablaphone.)',
            choicer.create('* (Equip the Tablaphone?)', 'Evet', 'Hayır')
        ],
                    ...
                    : [
                        ...(!SAVE.storage.inventory.has('tvm_mewmew') && // NO-TRANSLATE
                            ...
                            : [
                                ...
                                '<25>{#f/3}* Please?',
                                choicer.create('* (Give back the Mew Mew doll?)', 'Evet', 'Hayır')
                            ])
                    ])
            ],
            opera36b1: [
        ...
        overworld: {
            ...
            doublefridge2: () => [
                ...
                choicer.create('* (Take the opened bottle?)', 'Evet', 'Hayır')
            ],
            ...
            exofountain1: () => [
                ...
                choicer.create('* (Take a sip?)', 'Evet', 'Hayır')
            ],
            ...
            topdesk1: () =>
                SAVE.data.b.svr || world.bad_lizard > 1 || world.genocide || SAVE.data.n.state_foundry_undyne === 2
                    ...
                    : [
                        ...
                        choicer.create('* (Turn on the computer?)', 'Evet', 'Hayır')
                    ],
        ...
        dinnerdate1: pager.create(
            ...
            () => [
                ...
                choicer.create('* (Have dinner?)', 'Evet', 'Hayır')
            ],
            () => ['<25>{#p/sans}{#f/2}* changed your mind?', choicer.create('* (Have dinner?)', 'Evet', 'Hayır')]
        ),
                ...
                SAVE.data.n.plot === 72
                    ...
                    : SAVE.data.b.killed_mettaton
                        ...
                        : [
                            ...
                            choicer.create('* (Own a room?)', 'Evet', 'Hayır')
                        ],
            () =>
                SAVE.data.n.plot === 72
