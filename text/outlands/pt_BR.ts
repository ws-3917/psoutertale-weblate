...
export default {
    a_outlands: {
        ...
        danger_puzzle4: () => [
            ...
            choicer.create('* (Solve the riddle?)', 'Sim', 'Não')
        ],
        danger_puzzle5a: [
        ...
        dipper: {
            a: () => [
                ...
                choicer.create('* (Equip the Little Dipper?)', 'Sim', 'Não')
            ],
        ...
        fridgetrap: {
            ...
            b: () => [
                ...
                choicer.create('* (Take the Chocolate Bar?)', 'Sim', 'Não')
            ],
        ...
        front2: () => [
            ...
            ...(SAVE.data.n.state_wastelands_mash === 1
                ...
                : 3 <= SAVE.data.n.cell_insult
                    ...
                    : []),
            choicer.create("* (See Napstablook's show?)", 'Sim', 'Não')
        ],
        ...
        halo: {
            a: () => ['<32>{#p/human}* (You got the Halo.)', choicer.create('* (Equip the Halo?)', 'Sim', 'Não')],
            b: ["<32>{#p/human}* (Você está carregando muito pra levar isso.)"]
        },
        indie1: () => [
            ...([1, 5].includes(SAVE.data.n.state_wastelands_dummy) && SAVE.data.b.w_state_riddleskip
        ...
        indie1a: () => [
            ...
            choicer.create('* (Change your mind?)', 'Sim', 'Não')
        ],
        indie1b: () => [
                ...
                () =>
                    SAVE.data.b.napsta_performance
                        ? [
                            ...
                            choicer.create('{#n1!}* (Buy the Super Starwalker 1 for 5G?)', 'Sim', 'Não')
                        ]
                        : [
                            ...(world.postnoot
                                ? [
                            ...
                            choicer.create('{#n1!}* (Buy the Super Starwalker 1 for 10G?)', 'Sim', 'Não')
                        ],
                () =>
                    SAVE.data.b.napsta_performance
                        ? [
        ...
        socks1: () =>
            world.darker
                ...
                : [
                    ...
                    world.meanie
                        ? choicer.create('* (Make it messier?)', 'Sim', 'Não')
                        : choicer.create('* (Clean up the mess?)', 'Sim', 'Não')
                ],
        socks2: () =>
            world.meanie
                ...
                : [
                    ...
                    ...(SAVE.data.b.oops
                        ...
                        : [
                            ...
                            choicer.create('* (Take the key?)', 'Sim', 'Não')
                        ])
                ],
        socks3: () => [
            "<32>{#p/human}* (...)\n* (It appears there's a key hidden in the drawer.)",
        ...
        steaksale: {
            ...
            b: () => [
                ...
                SAVE.data.b.napsta_performance
                    ? choicer.create('* (Buy the Sizzli Steak for 40G?)', 'Sim', 'Não')
                    : choicer.create('* (Buy the Sizzli Steak for 20G?)', 'Sim', 'Não')
            ],
            ...
            c: () => [
                ...
                SAVE.data.b.napsta_performance
                    ? choicer.create('* (Buy the Fizzli Soda for 10G?)', 'Sim', 'Não')
                    : choicer.create('* (Buy the Fizzli Soda for 5G?)', 'Sim', 'Não')
            ],
                                ...
                                : SAVE.data.n.state_wastelands_toriel === 2
                                    ...
                                    : world.meanie
                                        ? [
                                            ...
                                            choicer.create('* (Smash the pie?)', 'Sim', 'Não')
                                        ]
