...
'<25>{#f/16}* 那傢伙\n  應該不想再\n  和我「玩」了。'
        ...
        front2: () => [
            ...
            ...(SAVE.data.n.state_wastelands_mash === 1
                ...
                : 3 <= SAVE.data.n.cell_insult
                    ...
                    : []),
            choicer.create("* （參加納普斯特的演出嗎？）", '參加', '算了')
        ],
    ...
    b_opponent_loox: {
        ...
        spareStatus: ["<32>{#p/story}* 乾瞪眼不想跟你打了。"],
    ...
    b_opponent_toriel: {
        ...
        status2: ['<32>{#p/story}* 托麗爾準備發動一次魔法攻擊。'],
        status3: ['<32>{#p/story}* 托麗爾板著臉，冷冷地看著你。'],
