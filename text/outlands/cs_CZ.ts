...
export default {
    a_outlands: {
        ...
        finaltext: {
            ...
            d38: ['<32>{#p/basic}* Pst...', "<32>* To je v pořádku.", "<32>* Mám vás, ano?"],
            d39: ['<25>{#p/asriel1}{#f/25“}{#i/4}* Já...'],
            d40: ["<32>{#p/basic}* Mám vás, Asrieli."],
            d41: [
                '<32>{#p/základní}* ... Cítím to.',
                '<32>* I po uplynutí sta let...',
