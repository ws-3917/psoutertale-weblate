...
'<25>{#f/16}* 那家伙\n  应该不想再\n  和我“玩”了。'
        ...
        front2: () => [
            ...
            ...(SAVE.data.n.state_wastelands_mash === 1
                ...
                : 3 <= SAVE.data.n.cell_insult
                    ...
                    : []),
            choicer.create("* （参加纳普斯特的演出吗？）", '参加', '算了')
        ],
    ...
    b_opponent_loox: {
        ...
        spareStatus: ["<32>{#p/story}* 干瞪眼不想跟你打了。"],
    ...
    b_opponent_toriel: {
        ...
        status2: ['<32>{#p/story}* 托丽尔准备发动一次魔法攻击。'],
        status3: ['<32>{#p/story}* 托丽尔板着脸，冷冷地看着你。'],
